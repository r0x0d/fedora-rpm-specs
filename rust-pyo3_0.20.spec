...
Patch:          0002-backport-support-for-Python-3.13.patch

# * make unsafe subinterpreter support available via cfg flag:
#   https://bugzilla.redhat.com/show_bug.cgi?id=2298403
Patch:          0003-Make-unsafe-subinterpreter-support-available-via-cfg.patch
...
# * skip one test that segfaults with Python 3.13 (removed in pyo3 0.21):
#   https://github.com/PyO3/pyo3/pull/3769
export LANG=C.utf8
%cargo_test -f auto-initialize -- -- --skip test_default_interpreter
%endif
