...
%changelog
* Fri Sep 13 2024 Adam Williamson <awilliam@redhat.com> - 2.6.16-1
- New release 2.6.16: avoid mwclient deprecations, drop pytz dep

* Thu Sep 12 2024 Adam Williamson <awilliam@redhat.com> - 2.6.15-1
- New release 2.6.15: add test data files missing from 2.6.14

* Thu Sep 12 2024 Adam Williamson <awilliam@redhat.com> - 2.6.14-1
- New release 2.6.14: update AMI page generation for new uploader

* Thu Aug 29 2024 Adam Williamson <awilliam@redhat.com> - 2.6.13-1
- New release 2.6.13: make cid_to_event fail for non-digit, non-Rawhide versions

* Thu Jul 25 2024 Miroslav Suchý <msuchy@redhat.com> - 2.6.12-4
- convert license to SPDX

* Fri Jul 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.6.12-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Sat Jun 08 2024 Python Maint <python-maint@redhat.com> - 2.6.12-2
