...
%patch -P2 -p1 -b .i18ntest
%patch -P3 -p1 -b .threadstest
%patch -P4 -p1 -b .gc_pkgconfig_private
%ifarch ppc64le
%patch -P5 -p1 -b .ieeetest
%endif
%patch -P6 -p1 -b .configure
%patch -P7 -p1
%patch -P8 -p1
...
%changelog
* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 5:2.0.14-37
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Wed Jan 24 2024 Fedora Release Engineering <releng@fedoraproject.org> - 5:2.0.14-36
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Sat Jan 20 2024 Fedora Release Engineering <releng@fedoraproject.org> - 5:2.0.14-35
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild
