...
Provides: bundled(golang(github.com/containerd/containerd)) = v1.7.22
...
Provides: bundled(golang(github.com/containerd/nydus_snapshotter)) = v0.13.7
...
Provides: bundled(golang(github.com/containers/image/v5)) = v5.32.2
Provides: bundled(golang(github.com/containers/storage)) = v1.55.0
...
Provides: bundled(golang(github.com/cpuguy83/go_md2man/v2)) = v2.0.4
Provides: bundled(golang(github.com/creack/pty)) = v1.1.21
Provides: bundled(golang(github.com/cyphar/filepath_securejoin)) = v0.3.1
...
Provides: bundled(golang(github.com/docker/cli)) = v27.2.1+incompatible
...
Provides: bundled(golang(github.com/docker/docker)) = v27.2.1+incompatible
...
Provides: bundled(golang(github.com/gogo/googleapis)) = v1.4.1
Provides: bundled(golang(github.com/gogo/protobuf)) = v1.3.2
Provides: bundled(golang(github.com/go_jose/go_jose/v4)) = v4.0.2
...
Provides: bundled(golang(github.com/klauspost/compress)) = v1.17.9
...
Provides: bundled(golang(github.com/Microsoft/hcsshim)) = v0.12.5
...
Provides: bundled(golang(github.com/moby/buildkit)) = v0.15.2
...
Provides: bundled(golang(github.com/moby/sys/signal)) = v0.7.0
...
Provides: bundled(golang(github.com/pierrec/lz4/v4)) = v4.1.19
Provides: bundled(golang(github.com/pkg/errors)) = v0.9.1
Provides: bundled(golang(github.com/pmezard/go_difflib)) = v1.0.1_0.20181226105442_5d4384ee4fb2
Provides: bundled(golang(github.com/prometheus/client_golang)) = v1.19.0
Provides: bundled(golang(github.com/prometheus/client_model)) = v0.6.0
Provides: bundled(golang(github.com/prometheus/common)) = v0.51.1
...
Provides: bundled(golang(github.com/sylabs/oci_tools)) = v0.13.0
Provides: bundled(golang(github.com/sylabs/scs_build_client)) = v0.9.13
Provides: bundled(golang(github.com/sylabs/scs_key_client)) = v0.7.7
Provides: bundled(golang(github.com/sylabs/scs_library_client)) = v1.4.10
Provides: bundled(golang(github.com/sylabs/sif/v2)) = v2.19.1
Provides: bundled(golang(github.com/sylabs/squashfs)) = v1.0.0
...
Provides: bundled(golang(github.com/tonistiigi/fsutil)) = v0.0.0_20240424095704_91a3fc46842c
...
Provides: bundled(golang(mvdan.cc/sh/v3)) = v3.9.0
