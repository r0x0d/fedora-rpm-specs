...
%changelog
* Fri Jul 19 2024 Jiri Vanek <jvanek@redhat.com> - 1:11.0.24.0.8-1
* July CPU

* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 1:11.0.23.0.9-1.1
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Tue Apr 30 2024 Jiri Vanek <jvanek@redhat.com> - 1:11.0.23.0.9-1
* April CPU
