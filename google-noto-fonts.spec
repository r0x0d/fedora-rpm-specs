...
%global rpmver	%{lua: print(string.format("%04d%02d%02d", tonumber(rpm.expand("%{majorver}")) + 2000, tonumber(rpm.expand("%{minorver}")), tonumber(rpm.expand("%{patchver}"))))}
# for default font
%global hprio	56
