...
# * bump ttf-parser dependency from 0.17 to 0.18
Patch:          plotters-fix-metadata.diff
...
%if %{with check}
%check
# * skip doctests which require files that are not included in published crates
