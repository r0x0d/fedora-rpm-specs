...
# drop unpackaged color-eyre dev-dependency
Patch:          interprocess-fix-metadata.diff
# Drop references to deleted tests due to missing color-eyre
Patch:          interprocess-no-tests.diff
...
%cargo_prep
#tests: unpackaged color-eyre dev-dependency
rm -rf tests
