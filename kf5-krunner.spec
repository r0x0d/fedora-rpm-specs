...
License: BSD-2-Clause AND CC0-1.0 AND LGPL-2.0-or-later AND LGPL-2.1-or-later AND LicenseRef-KDE-Accepted-GPL
...
* Tue Jul 14 2020 Rex Dieter <rdieter@fedoraproject.org> - 5.72.0-2
...
- -devel: Conflicts: kapptemplate < 16.03.80

* Fri Apr 08 2016 Rex Dieter <rdieter@fedoraproject.org> - 5.21.0-2
- remove conflict (with kapptemplate): kdevappwizard/template/runner
