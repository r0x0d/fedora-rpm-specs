...
%changelog
* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 7.2.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Tue Jun 30 2026 Mads Kiilerich <mads@kiilerich.com> - 7.2.2-1
- tortoisehg 7.2.2

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 7.0.1-7
- Rebuilt for Python 3.15

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 7.0.1-6
