...
* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 2.2.0-2
...
* Wed Aug 28 2024 Miroslav Suchý <msuchy@redhat.com> - 2.1.1-9
- convert license to SPDX

* Wed Jul 17 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.1-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Sat Jun 08 2024 Python Maint <python-maint@redhat.com> - 2.1.1-7
...
* Thu Jun 15 2023 Python Maint <python-maint@redhat.com> - 2.1.1-3
- Rebuilt for Python 3.12

* Thu Jan 19 2023 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_38_Mass_Rebuild

* Thu Aug 25 2022 Michael Cronenworth <mike@cchtml.com> - 2.1.1-1
- Version update (RHBZ#2120243)

* Thu Jul 21 2022 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.5-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Sun Jun 19 2022 Python Maint <python-maint@redhat.com> - 2.0.5-3
- Rebuilt for Python 3.11

* Thu Jan 20 2022 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.5-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Wed Dec 15 2021 Michael Cronenworth <mike@cchtml.com> - 2.0.5-1
- Version update

* Mon Dec 13 2021 Michael Cronenworth <mike@cchtml.com> - 2.0.4-1
- Version update

* Mon Dec 06 2021 Michael Cronenworth <mike@cchtml.com> - 2.0.3-20
- Add patch for compatbility with rb_libtorrent 2.0 (RHBZ#2007467)

* Mon Dec 06 2021 Michael Cronenworth <mike@cchtml.com> - 2.0.3-19
- Add patches for compatbility with rb_libtorrent 2.0 (RHBZ#2026730)

* Tue Aug 31 2021 Michael Cronenworth <mike@cchtml.com> - 2.0.3-18
- Add patch for pidfile option (RHBZ#1969597)

* Wed Jul 21 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.3-17
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Fri Jun 04 2021 Python Maint <python-maint@redhat.com> - 2.0.3-16
- Rebuilt for Python 3.10

* Tue May 25 2021 Leigh Scott <leigh123linux@gmail.com> - 2.0.3-15
- Rebuild for new libtorrent

* Tue Mar 02 2021 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 2.0.3-14
...
* Tue Apr 21 2020 Michael Cronenworth <mike@cchtml.com> - 2.0.3-7
- Fix torrent status GTK UI placement (RHBZ#1826485)

* Tue Jan 28 2020 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.3-6
...
* Mon Aug 19 2019 Miro Hrončok <mhroncok@redhat.com> - 2.0.3-3
- Rebuilt for Python 3.8

* Wed Jul 24 2019 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.3-2
