...
#   tar xf glycin-%%{gnome_tarball_version}.tar.xz
#   pushd glycin-%%{gnome_tarball_version}
#   patch -p1 < ../0001-fix-invalid-crate-manifest-for-tests-workspace-membe.patch
#   cargo vendor --versioned-dirs
#   tar Jcvf ../glycin-%%{gnome_tarball_version}-vendor.tar.xz vendor/
#   popd
Source1:        glycin-%{gnome_tarball_version}-vendor.tar.xz
...
%autosetup -n %{name}-%{gnome_tarball_version} -N -a1
%autopatch -p1 -M 0
%cargo_prep -v vendor
%else
%autosetup -n %{name}-%{gnome_tarball_version} -N
%autopatch -p1
rm -rf vendor
%cargo_prep
%endif
