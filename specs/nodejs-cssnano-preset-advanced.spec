%global npm_name cssnano-preset-advanced
...
compact CSS appropriately. This package is a preset for cssnano that
provides advanced optimisations, which may or may not break your CSS.
}
