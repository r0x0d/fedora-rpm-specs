...
* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 1.16.0-2
- Rebuilt for Python 3.15

* Tue Mar 03 2026 Artur Frenszek-Iwicki <fedora@svgames.pl> - 1.16.0-1
- Update to v1.16.0
...
* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 1.15.0-4
- Rebuilt for Python 3.14.0rc2 bytecode

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.15.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sun Jul 06 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 1.15.0-2
- Rebuilt for Python 3.14 (close RHBZ#2371740)

* Sun Apr 13 2025 Artur Frenszek-Iwicki <fedora@svgames.pl> - 1.15.0-1
- Upgrade to v1.15.0
