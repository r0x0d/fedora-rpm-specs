...
%{_libdir}/python%{python3_version}/site-packages/qcustomplot_pyqt5-%{version}.dist-info/*

%files -n python3-qcustomplot-pyqt6
%doc README.md
%license LICENSE-MIT.txt LICENSE-gpl-3.0.txt
%{_libdir}/python%{python3_version}/site-packages/QCustomPlot_PyQt6*
%{_libdir}/python%{python3_version}/site-packages/qcustomplot_pyqt6-%{version}.dist-info/*


%changelog
* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 2.1.1.2-9
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.1.2-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 2.1.1.2-7
- Rebuilt for Python 3.15

* Wed May 20 2026 TI_Eugene <ti.eugene@gmail.com> - 2.1.1.2-6
- Build fix

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.1.2-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.1.2-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 2.1.1.2-3
- Rebuilt for Python 3.14

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.1.2-2
