...
%changelog
* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 1.30.14-5
- Rebuilt for Python 3.15.0b4 ABI change

* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.30.14-4
...
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 1.30.5-5
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 1.30.5-4
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.30.5-3
