...
%changelog
* Mon Feb 09 2026 Martin Gansser <martinkg@fedoraproject.org> - 0.7.0-44
- Rebuilt for new VDR API version 2.7.9

* Mon Jan 26 2026 Martin Gansser <martinkg@fedoraproject.org> - 0.7.0-43
- Rebuilt for new VDR API version 2.7.8

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.7.0-42
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jul 25 2025 Martin Gansser <martinkg@fedoraproject.org> - 0.7.0-41
...
* Tue May 27 2025 Martin Gansser <martinkg@fedoraproject.org> - 0.7.0-38
- Rebuilt for new VDR API version 2.7.5

* Fri Feb 28 2025 Martin Gansser <martinkg@fedoraproject.org> - 0.7.0-37
- Rebuilt for new VDR API version 2.7.4

* Sun Jan 19 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.7.0-36
