...
Source0:        https://tarballs.openstack.org/%{pypi_name}/oslo_serialization-%{upstream_version}.tar.gz
# Required for tarball sources verification
%if 0%{?sources_gpg} == 1
Source101:        https://tarballs.openstack.org/%{pypi_name}/oslo_serialization-%{upstream_version}.tar.gz.asc
...
%endif
%autosetup -n oslo_serialization-%{upstream_version} -S git
