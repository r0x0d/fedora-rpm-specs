...
%changelog
* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1:12.1.0.0-152
...
* Tue Mar 4 2025 Jijun Wang <jijun.wang@intel.com> - 12.0.0.0-37
- Changed to use tclsh8 when possible
- Changed rpm spec to require tcl < 1:9

* Mon Mar 3 2025 Jijun Wang <jijun.wang@intel.com> - 12.0.0.0-36
