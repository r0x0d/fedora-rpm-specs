...
%global __provides_exclude_from \
         ^(%{_qt6_libdir}/libgammaray.*\\.so)$

Obsoletes: %{name}-qt5 < %{version}-%{release}
Obsoletes: %{name}-probe-qt5 < %{version}-%{release}
Obsoletes: %{name}-probe-qt5-devel < %{version}-%{release}
...
%prep
%autosetup -n GammaRay-%{version} -p1
...
%changelog
* Tue Aug 25 2026 Jan Grulich <jgrulich@redhat.com> - 3.4.0-4
- Rebuild (qt6)

* Wed Jul 15 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.4.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed May 13 2026 Jan Grulich <jgrulich@redhat.com> - 3.4.0-2
- Rebuild (qt6)

* Fri Apr 17 2026 Jan Grulich <jgrulich@redhat.com> - 3.4.0-1
- Update to 3.4.0
- Drop Qt5 support

* Thu Apr 16 2026 Jan Grulich <jgrulich@redhat.com> - 3.1.0-21
- Rebuild (qt6)

* Thu Apr 02 2026 Jan Grulich <jgrulich@redhat.com> - 3.1.0-20
- Rebuild (qt6)
...
* Fri Nov 21 2025 Jan Grulich <jgrulich@redhat.com> - 3.1.0-17
- Rebuild (qt6)

* Tue Nov 04 2025 Jan Grulich <jgrulich@redhat.com> - 3.1.0-16
- Rebuild (qt5)
...
* Mon Sep 01 2025 Jan Grulich <jgrulich@redhat.com> - 3.1.0-13
- Rebuild (qt6)

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.1.0-12
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Fri Jun 06 2025 Jan Grulich <jgrulich@redhat.com> - 3.1.0-11
- Rebuild (qt6)

* Mon May 26 2025 Jan Grulich <jgrulich@redhat.com> - 3.1.0-10
- Rebuild (qt5)

* Tue Mar 25 2025 Jan Grulich <jgrulich@redhat.com> - 3.1.0-9
- Rebuild (qt6)

* Mon Feb 03 2025 Jan Grulich <jgrulich@redhat.com> - 3.1.0-8
- Rebuild (qt6)

* Wed Jan 22 2025 Jan Grulich <jgrulich@redhat.com> - 3.1.0-7
- Rebuild (qt5)

* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.1.0-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Tue Jan 14 2025 Jan Grulich <jgrulich@redhat.com> - 3.1.0-5
- Rebuild (qt5)

* Mon Dec 09 2024 Jan Grulich <jgrulich@redhat.com> - 3.1.0-4
- Rebuild (qt6)
