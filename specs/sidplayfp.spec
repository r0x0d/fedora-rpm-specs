...
%changelog
* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.15.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Wed Aug 13 2025 Karel Volný <kvolny@redhat.com> - 2.15.0-1
- Update to 2.15.0 (rhbz#2359282)
- See the upstream changes at https://github.com/libsidplayfp/sidplayfp/releases

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.12.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sun Jan 19 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.12.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Fri Dec 13 2024 Karel Volný <kvolny@redhat.com> - 2.12.0-1
- Update to 2.12.0 (rhbz#2329755)
- See the upstream changes at https://github.com/libsidplayfp/sidplayfp/releases
