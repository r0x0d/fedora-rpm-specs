...
%{?with_videx:Suggests:        %{pkgname}-videx-engine%{?_isa} = %{sameevr}}
...
%description      -n %{pkgname}-videx-engine
The VIDEX storage engine for MariaDB.
%endif
...
%if %{with videx}
%files -n %{pkgname}-videx-engine
%{_libdir}/%{majorname}/plugin/ha_videx.so
...
* Fri Jun 12 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 3:12.3.1-3
