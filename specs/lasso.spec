...
%changelog
* Thu Jul 23 2026 Jitka Plesnikova <jplesnik@redhat.com> - 2.9.0-9
- Perl 5.44 rebuild

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 2.9.0-8
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.9.0-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Fri Jun 12 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 2.9.0-6
- Rebuilt for openssl 4.0

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 2.9.0-5
