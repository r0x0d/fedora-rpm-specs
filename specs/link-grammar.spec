...
%changelog
* Fri Jul 24 2026 Python Maint <python-maint@redhat.com> - 5.12.7-8
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 23 2026 Jitka Plesnikova <jplesnik@redhat.com> - 5.12.7-7
- Perl 5.44 rebuild

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 5.12.7-6
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 5.12.7-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 5.12.7-4
- Rebuilt for Python 3.15

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 5.12.7-3
...
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 5.12.5-6
...
* Mon Jul 07 2025 Jitka Plesnikova <jplesnik@redhat.com> - 5.12.5-3
- Perl 5.42 rebuild

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 5.12.5-2
- Rebuilt for Python 3.14

* Tue Feb 04 2025 Gwyn Ciesla <gwync@protonmail.com> - 5.12.5-1
- 5.12.5

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 5.12.3-12
