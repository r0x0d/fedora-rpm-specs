...
Name:           liblas
Version:        1.8.2
Release:        0.33%{?shortcommit:.git%shortcommit}%{?dist}
...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.8.2-0.33.git0839c6c
...
* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.8.2-0.24.git62f3d57
...
* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.8.2-0.21.git96d4dc9
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Sat Nov 09 2024 Sandro Mani <manisandro@gmail.com> - 1.8.2-0.20.git96d4dc9
- Rebuild (GDAL)

* Sat Nov 09 2024 Sandro Mani <manisandro@gmail.com> - 1.8.2-0.19.git96d4dc9
- Rebuild (GDAL)
