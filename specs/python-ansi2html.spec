...
* Sun Aug 30 2026 Federico Pellegrin <fede@evolware.org> - 1.9.3-1
- Upgrade to 1.9.3 (rhbz#2525929)

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.9.2-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 1.9.2-9
...
* Thu Jul 24 2025 Federico Pellegrin <fede@evolware.org> - 1.9.2-5
- Remove STI tests (opt for integrated ones) (rhbz#2383027)

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 1.9.2-4
