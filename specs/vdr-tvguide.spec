...
* Mon Mar 23 2026 Martin Gansser <martinkg@fedoraproject.org> - 1.3.12-2
- Rebuilt for new VDR 2.8.1 API version 12

* Thu Feb 19 2026 Martin Gansser <martinkg@fedoraproject.org> - 1.3.12-1
- Update to 1.3.12

* Mon Feb 09 2026 Martin Gansser <martinkg@fedoraproject.org> - 1.3.11-6
- Rebuilt for new VDR API version 2.7.9

* Mon Jan 26 2026 Martin Gansser <martinkg@fedoraproject.org> - 1.3.11-5
- Rebuilt for new VDR API version 2.7.8

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.3.11-4
