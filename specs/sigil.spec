...
* Tue Dec 02 2025 Jan Grulich <jgrulich@redhat.com> - 2.6.2-3
- Rebuild (python-pyside6)

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 2.6.2-2
- Rebuilt for Python 3.14.0rc3 bytecode

* Sat Sep 13 2025 Dan Horák <dan[at]danny.cz> - 2.6.2-1
- New upstream release 2.6.2 (rhbz#2394929)

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 2.6.0-2
- Rebuilt for Python 3.14.0rc2 bytecode

* Thu Jul 24 2025 Dan Horák <dan[at]danny.cz> - 2.6.0-1
- New upstream release 2.6.0 (rhbz#2381846)

* Fri Jun 06 2025 Python Maint <python-maint@redhat.com> - 2.5.2-2
- Rebuilt for Python 3.14

* Wed Jun 04 2025 Dan Horák <dan[at]danny.cz> - 2.5.2-1
- New upstream release 2.5.2 (rhbz#2370261)
