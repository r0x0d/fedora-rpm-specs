...
%changelog
* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 0.16.3-11
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.16.3-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 0.16.3-9
- Rebuilt for Python 3.15

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.16.3-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 0.16.3-7
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 0.16.3-6
- Rebuilt for Python 3.14.0rc2 bytecode

* Tue Aug 05 2025 Charalampos Stratakis <cstratak@redhat.com> - 0.16.3-5
- Fix compatibility with Cython >= 3.1
- Fixes: rhbz#2377046

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.16.3-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jul 15 2025 Martin Gansser <martinkg@fedoraproject.org> - 0.16.3-3
