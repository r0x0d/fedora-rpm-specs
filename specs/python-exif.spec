...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.5.1-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 3.5.1-4
- Rebuilt for Python 3.15

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.5.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 3.5.1-2
- Rebuilt for Python 3.14.0rc3 bytecode

* Sun Aug 24 2025 Terje Rosten <terjeros@gmail.com> - 3.5.1-1
- 3.5.1

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 3.4.0-2
- Rebuilt for Python 3.14.0rc2 bytecode

* Thu Aug 07 2025 Terje Rosten <terjeros@gmail.com> - 3.4.0-1
- 3.4.0
