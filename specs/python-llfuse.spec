...
%changelog
* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 1.5.2-5
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.5.2-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 1.5.2-3
- Rebuilt for Python 3.15

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.5.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Sat Jan 03 2026 Felix Schwarz <fschwarz@fedoraproject.org> - 1.5.2-1
- update to 1.5.2

* Mon Jul 28 2025 Felix Schwarz <fschwarz@fedoraproject.org> - 1.5.1-5
- use pyproject packaging macros (rhbz #2377861)
