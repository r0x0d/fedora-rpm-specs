...
BuildRequires:  pkgconfig(gstreamer-base-1.0) >= 1.14
...
This package contains library source intended for building other packages which
use the "v1_14_3" feature of the "%{crate}" crate.
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-base-1.0) >= 1.16
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-base-1.0) >= 1.18
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-base-1.0) >= 1.20
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-base-1.0) >= 1.22
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-base-1.0) >= 1.24
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-base-1.0) >= 1.26
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-base-1.0) >= 1.28
