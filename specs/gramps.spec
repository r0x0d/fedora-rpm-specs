...
* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 6.0.8-2
- Rebuilt for Python 3.15

* Fri Apr 10 2026 Gwyn Ciesla <gwync@protonmail.com> - 6.0.8-1
- 6.0.8

* Wed Mar 25 2026 Gwyn Ciesla <gwync@protonmail.com> - 6.0.7-1
- 6.0.7

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 6.0.6-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Nov 10 2025 Gwyn Ciesla <gwync@protonmail.com> - 6.0.6-1
- 6.0.6

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 6.0.5-2
- Rebuilt for Python 3.14.0rc3 bytecode

* Mon Sep 08 2025 Gwyn Ciesla <gwync@protonmail.com> - 6.0.5-1
- 6.0.5

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 6.0.4-2
- Rebuilt for Python 3.14.0rc2 bytecode

* Mon Aug 11 2025 Gwyn Ciesla <gwync@protonmail.com> - 6.0.4-1
- 6.0.4

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 6.0.3-3
...
* Mon Jun 16 2025 Gwyn Ciesla <gwync@protonmail.com> - 6.0.2-1
- 6.0.2

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 6.0.1-2
...
* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 5.2.4-2
