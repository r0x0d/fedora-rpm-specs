...
# Version from node-v26.5.1/src/node_version.h
%global node_soversion 147

# Version from node-v26.5.1/deps/ada/ada.h
%nodejs_define_version ada 3.4.4
# Version from node-v26.5.1/deps/brotli/c/common/version.h
%nodejs_define_version brotli 1.2.0
# Version from node-v26.5.1/deps/cares/include/ares_version.h
%nodejs_define_version c_ares 1.34.6
# Version from node-v26.5.1/deps/histogram/include/hdr/hdr_histogram_version.h
%nodejs_define_version histogram 0.11.9
# Version from node-v26.5.1/tools/icu/current_ver.dep
%nodejs_define_version icu 78.3 -p
# Version from node-v26.5.1/deps/uv/include/uv/version.h
%nodejs_define_version libuv 1.52.1
# Version from node-v26.5.1/deps/llhttp/include/llhttp.h
%nodejs_define_version llhttp 9.4.3
# Version from node-v26.5.1/deps/merve/merve.h
%nodejs_define_version merve 1.2.2
# Version from node-v26.5.1/deps/nghttp2/lib/includes/nghttp2/nghttp2ver.h
%nodejs_define_version nghttp2 1.69.0
# Version from node-v26.5.1/deps/ngtcp2/nghttp3/lib/includes/nghttp3/version.h
%nodejs_define_version nghttp3 1.17.0
# Version from node-v26.5.1/deps/ngtcp2/ngtcp2/lib/includes/ngtcp2/version.h
%nodejs_define_version ngtcp2 1.23.0
# Version from node-v26.5.1/deps/minimatch/package.json
%nodejs_define_version nodejs-minimatch 10.2.5
# Version from node-v26.5.1/lib/punycode.js
%nodejs_define_version nodejs-punycode 2.1.0
# Version from node-v26.5.1/deps/undici/src/package.json
%nodejs_define_version nodejs-undici 8.9.0
# Version from node-v26.5.1/deps/npm/package.json
%nodejs_define_version npm 2:11.17.0-%{nodejs_subpackage_release}
# Version from node-v26.5.1/deps/sqlite/sqlite3.h
%nodejs_define_version sqlite 3.53.3
# Version from node-v26.5.1/deps/uvwasi/include/uvwasi.h
%nodejs_define_version uvwasi 0.0.23
# Version from node-v26.5.1/deps/v8/include/v8-version.h
%nodejs_define_version v8 3:14.6.202.34-%{nodejs_subpackage_release} -p
# Version from node-v26.5.1/deps/zlib/zlib.h
...
BuildRequires:  clang >= 10.0, llvm, pkgconf, ninja-build
...
0006-v8-memcopy-include-climits-for-CHAR_BIT.patch
...
readonly -a extra_cflags=(
    ...
    -DOPENSSL_NO_ENGINE
    # 2022-07-14: There's a bug in either torque or compiler that causes a
    ...
    -O3
    # v8 segfaults when certain optimizations are enabled
    # - https://github.com/nodejs/node/issues/47865
    # Use clang-specific flags to disable problematic optimizations
    -fno-optimize-sibling-calls
    # Disable thin LTO in CXXFLAGS to avoid conflict with --enable-lto
    # -flto=thin
)
# configuration flags
