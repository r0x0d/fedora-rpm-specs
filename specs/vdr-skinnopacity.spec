...
* Mon Mar 23 2026 Martin Gansser <martinkg@fedoraproject.org> - 1.1.19-11
- Rebuilt for new VDR 2.8.1 API version 12

* Mon Feb 09 2026 Martin Gansser <martinkg@fedoraproject.org> - 1.1.19-10
- Rebuilt for new VDR API version 2.7.9

* Mon Jan 26 2026 Martin Gansser <martinkg@fedoraproject.org> - 1.1.19-9
- Rebuilt for new VDR API version 2.7.8

* Tue Jan 20 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.1.19-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jul 25 2025 Martin Gansser <martinkg@fedoraproject.org> - 1.1.19-7
- Rebuilt for new VDR API version 2.7.7

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.1.19-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sat Jun 21 2025 Martin Gansser <martinkg@fedoraproject.org> - 1.1.19-5
- Rebuilt for new VDR API version 2.7.6

* Tue May 27 2025 Martin Gansser <martinkg@fedoraproject.org> - 1.1.19-4
...
* Wed Nov 20 2024 Martin Gansser <martinkg@fedoraproject.org> - 1.1.19-1
- Update to 1.1.19

* Wed Oct 09 2024 Martin Gansser <martinkg@fedoraproject.org> - 1.1.18-1
