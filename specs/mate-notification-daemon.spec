...
# https://github.com/mate-desktop/mate-notification-daemon/commit/90b39ec
Patch1: mate-notification-daemon_0001-daemon-Properly-update-the-set-of-monitors-when-it-c.patch
