...
%package        gnome-time-of-day
Summary:        Fedora  %{relnum} time of day default wallpaper for Gnome and Cinnamon
Requires:       %{name}-base = %{version}-%{release}
Supplements:    %{name}-gnome = %{version}-%{release}

%description    gnome-time-of-day
This package contains Gnome/Cinnamon desktop time of day file for the
Fedora  %{relnum} default theme.
...
%package        mate-time-of-day
Summary:        Fedora %{relnum} time of day default wallpaper for Mate
Requires:       %{name}-base = %{version}-%{release}
Supplements:    %{name}-mate = %{version}-%{release}

%description    mate-time-of-day
This package contains Mate desktop tile of day file for the Fedora  %{relnum}
default theme.
...
%files gnome-time-of-day
%{_datadir}/gnome-background-properties/%{bgname}-tod.xml
...
%files mate-time-of-day
%{_datadir}/mate-background-properties/%{bgname}-tod.xml
