...
Patch:          Make-buildContext-nullable.patch
...
%pom_remove_plugin eu.maveniverse.maven.plugins:njord
%pom_xpath_remove "pom:extensions/pom:extension[pom:groupId='eu.maveniverse.maven.njord']"
