...
* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 4.0.1-6
...
* Mon Jun 09 2025 Brian C. Lane <bcl@redhat.com> - 4.0.1-1
- Update to new upstream version 4.0.1
- Update spec to use pyproject_ macros
- Drop html docs, generation with sphinx no longer works
- Use docopt-ng on Fedora

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 3.3.1-14
- Rebuilt for Python 3.14

* Mon Jan 20 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.3.1-13
