...
%changelog
* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 7.1.10-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 7.1.10-9
...
* Fri Jul 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 7.1.10-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Fri Jun 07 2024 Python Maint <python-maint@redhat.com> - 7.1.10-5
...
* Mon Jan 22 2024 Fedora Release Engineering <releng@fedoraproject.org> - 7.1.10-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Tue Nov 07 2023 Barry A. Scott <barry@barrys-emacs.org> - 7.1.10-1
- python 3.13a1 support

* Fri Jul 21 2023 Fedora Release Engineering <releng@fedoraproject.org> - 7.1.8-4
...
* Fri Jan 20 2023 Fedora Release Engineering <releng@fedoraproject.org> - 7.1.7-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_38_Mass_Rebuild

* Fri Jul 22 2022 Fedora Release Engineering <releng@fedoraproject.org> - 7.1.7-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Mon Jun 13 2022 Python Maint <python-maint@redhat.com> - 7.1.7-2
- Rebuilt for Python 3.11

* Sun Feb 13 2022 Barry A. Scott <barry@barrys-emacs.org> - 7.1.7-1
- Update to 7.1.7 to be in sync with upstream.
  This includes support for Python 3.11 alpha 4

* Fri Jan 21 2022 Fedora Release Engineering <releng@fedoraproject.org> - 7.1.4-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Fri Jul 23 2021 Fedora Release Engineering <releng@fedoraproject.org> - 7.1.4-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Fri Jun 04 2021 Python Maint <python-maint@redhat.com> - 7.1.4-5
- Rebuilt for Python 3.10

* Wed Jan 27 2021 Fedora Release Engineering <releng@fedoraproject.org> - 7.1.4-4
