...
Name:		php-facedetect
Version:	1.2.0
Release:	0.44.%{commitdate}git%{shortcommit}%{?dist}
...
%changelog
* Tue Feb 04 2025 Sérgio Basto <sergio@serjux.com> - 1.2.0-0.44.20201021git2a8974b
- Rebuild for opencv-4.11.0

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.2.0-0.43.20201021git2a8974b
