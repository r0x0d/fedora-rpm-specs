...
%changelog
* Tue Mar 03 2026 Vincent Mihalkovic <vmihalko@redhat.com> - 2.3.1-1
- update to 2.3.1, switch source to GitLab unix-tree archive
- refresh patches for 2.3.1 (tree-static-analysis.patch tree.c hunk)
