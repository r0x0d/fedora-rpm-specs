...
* Thu Jul 23 2026 Jitka Plesnikova <jplesnik@redhat.com> - 2.8.1-19
- Perl 5.44 rebuild

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 2.8.1-18
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.8.1-17
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Fri Jun 12 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 2.8.1-16
- Rebuilt for openssl 4.0

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 2.8.1-15
