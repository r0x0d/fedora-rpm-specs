...
sed -i -r 's/aiohttp>=3.13.5,<3.14/aiohttp>=3.9.3/' requirements.txt
...
* Mon Mar 23 2026 Alexey Kurov <nucleo@fedoraproject.org> - 2.2.57-1
- Update to 2.2.57
...
* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 2.2.54-6
