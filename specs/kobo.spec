...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.42.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 0.42.0-2
- Rebuilt for Python 3.15

* Wed May 27 2026 Kamil Dudka <kdudka@redhat.com> - 0.42.0-1
- rebase to latest upstream release (rhbz#2481849)
...
* Tue Sep 30 2025 Kamil Dudka <kdudka@redhat.com> - 0.41.0-1
- rebase to latest upstream release (rhbz#2328602)
...
* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.38.0-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 0.38.0-3
- Rebuilt for Python 3.14

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.38.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Tue Nov 19 2024 Kamil Dudka <kdudka@redhat.com> - 0.38.0-1
