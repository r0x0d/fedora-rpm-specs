...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.2.6-11
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Sat Feb 14 2026 Cristian Le <git@lecris.dev> - 1.2.6-10
- Use standard CMake macros (rhbz#2381094)

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.2.6-9
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Nov 11 2025 Cristian Le <git@lecris.dev> - 1.2.6-8
- Allow to build with CMake 4.0 (rhbz#2381355)

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.2.6-7
