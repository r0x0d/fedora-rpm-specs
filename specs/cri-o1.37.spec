...
%global crio_spec_name  cri-o1.37
%global crio_spec_ver   1.37.0
# Uncomment if needed for commit based release
# %%global crio_commit     
%global crio_tag        v1.37.0
...
# install pinns in cri-o libexexdir
# makefile output for pinns hard coded to ../bin
install -m 0755 -vp ./bin/pinns    %{buildroot}%{_libexecdir}/crio/
...
%fdupes %{buildroot}%{_datadir}/licenses/%{crio_spec_name}
