...
# * Update procfs to 0.18, https://github.com/cooperlees/monitord/pull/134
...
%{cargo_test -- -- --exact %{shrink:
    --skip networkd::tests::test_parse_interface_state_files
    --skip networkd::tests::test_parse_interface_state_files_json
}}
%endif
