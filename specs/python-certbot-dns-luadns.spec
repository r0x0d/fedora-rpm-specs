...
%changelog
* Tue Aug 11 2026 Python Maint <python-maint@redhat.com> - 2.1.0-14
- Rebuilt for Python 3.15

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.0-13
...
* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 2.1.0-10
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.0-9
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Fri Jun 27 2025 Python Maint <python-maint@redhat.com> - 2.1.0-8
