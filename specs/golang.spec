...
Provides: bundled(golang(golang.org/x/mod)) = 0.36.1.0.20260520130633.087f6515dd3b
...
Provides: bundled(golang(golang.org/x/net)) = 0.55.1.0.20260526154343.657eb1317b5d
...
Provides: bundled(golang(golang.org/x/tools)) = 0.45.1.0.20260604184323.2111063761b3
