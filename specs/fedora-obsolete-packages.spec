...
%obsolete pagure-dist-git 1.15-3
...
%obsolete python-nipy-doc 1:0.6.1-5
...
%obsolete python3-PyQt4 4.12.3-48
%obsolete python3-PyQt4-devel 4.12.3-48
%obsolete python3-PyQt4-webkit 4.12.3-48
...
%obsolete python3-XStatic-Angular-FileUpload 12.0.4.0-32
%obsolete python3-XStatic-Angular-Gettext 2.1.0.2-33
%obsolete python3-XStatic-Angular-Mock 1.2.1.1-35
%obsolete python3-XStatic-Angular-lrdragndrop 1.0.2.2-34
%obsolete python3-XStatic-Bootstrap-Datepicker 1.3.1.0-35
%obsolete python3-XStatic-D3 3.5.17.0-29
%obsolete python3-XStatic-Font-Awesome 6.2.1.1-9
...
%obsolete python3-XStatic-bootswatch 3.3.7.0-29
%obsolete python3-XStatic-mdi 1.6.50.2-19
...
%obsolete python3-adafruit-board-toolkit 1.1.2-3
...
%obsolete python3-agate 1.12.0-3
%obsolete python3-agate-dbf 0.2.3-4
%obsolete python3-agate-excel 0.4.1-4
%obsolete python3-agate-sql 0.7.2-4
...
%obsolete python3-aiohttp-negotiate 0.11-28
...
%obsolete python3-arpeggio 2.0.2-8
...
%obsolete python3-bleach+css 6.2.0-4
%obsolete python3-bluepyopt 1.14.11-4
%obsolete python3-bowler 0.9.0-16
%obsolete python3-bowler-docs 0.9.0-16
%obsolete python3-box 7.2.0-3
%obsolete python3-brial 1.2.12-8
%obsolete python3-brian2 2.9.0-3
%obsolete python3-bsmschema 0.1.1-2
...
%obsolete python3-csvkit 2.0.1-3
...
%obsolete python3-fissix 20.8.0-17
...
%obsolete python3-gcsfs 2025.9.0-2
%obsolete python3-gcsfs+crc 2025.9.0-2
%obsolete python3-gcsfs+gcsfuse 2025.9.0-2
...
%obsolete python3-ipython+notebook 8.36.0-3
...
%obsolete python3-jupyter-c-kernel 1.2.2-26
...
%obsolete python3-libqtile+wayland 0.32.0-2
...
%obsolete python3-markdown_2 3.4.4-7
...
%obsolete python3-microfs 1.3.1-25
...
%obsolete python3-ncclient 0.6.19-2
...
%obsolete python3-nikola 8.3.0-5
%obsolete python3-nikola+extras 8.3.0-5
%obsolete python3-nilearn 0.11.1-4
%obsolete python3-nipy 1:0.6.1-5
%obsolete python3-nipy+optional 1:0.6.1-5
...
%obsolete python3-nudatus 0.0.5-21
...
%obsolete python3-pandas-flavor 0.6.0-8
...
%obsolete python3-parameterized 0.9.0-12
%obsolete python3-parver 0.5-3
...
%obsolete python3-pyedflib 0.1.42-2
%obsolete python3-pyelectro 0.2.7-7
...
%obsolete python3-pygls+ws 1.3.1-2
...
%obsolete python3-pytest-runner 4.0-28
...
%obsolete python3-pyudev-qt4 0.24.3-5
...
%obsolete python3-ratelimitingfilter 1.5-14
%obsolete python3-ratinabox 1.15.3-2
%obsolete python3-rawkit 0.6.0-22
%obsolete python3-rdopkg 1.7.0-8
...
%obsolete python3-renderspec 2.2.0-10
...
%obsolete python3-strictyaml 1.7.3-11
%obsolete python3-subarulink 0.3.11-17
%obsolete python3-system-calls 6.11.0-3
...
%obsolete totpcgi 0.6.0-0.23
%obsolete totpcgi-provisioning 0.6.0-0.23
%obsolete totpcgi-selinux 0.6.0-0.23
