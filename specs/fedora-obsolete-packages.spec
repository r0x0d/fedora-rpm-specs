...
%obsolete gfal2-util-scripts 1.9.1-2
...
%obsolete python3-dataclassy 1.0.1-3
...
%obsolete python3-dolfin 2019.1.0.post0-57
...
%obsolete python3-gfal2 1.13.1-2
%obsolete python3-gfal2-util 1.9.1-2
...
%obsolete python3-reactivex 4.0.4-9
...
%obsolete cekit 4.16.0-2
%obsolete cinch 1.4.0-27
%obsolete dib-utils 0.0.11-26
%obsolete dnf-plugin-ovl 0.0.3-24
%obsolete dnfdaemon 0.3.22-12
%obsolete dnfdaemon-selinux 0.3.22-12
%obsolete dput-ng 1.21-28
%obsolete elements 6.3.4-7
%obsolete elements-alexandria 2.32.0-7
%obsolete elements-alexandria-devel 2.32.0-7
...
%obsolete mopidy 4.0.0~a15-2
%obsolete mopidy-mpd 4.0.0~a4-2
%obsolete mu 1.2.0-25
%obsolete muse 1:4.2.1-10
%obsolete nikola 8.3.3-5
%obsolete nwg-panel 0.10.5-7
%obsolete obserware 0.2.10-6
%obsolete odcs 0.9.0-6
%obsolete odcs-client 0.9.0-6
%obsolete opae 2.13.0-4
%obsolete opae-devel 2.13.0-4
%obsolete opae-extra-tools 2.13.0-4
%obsolete pagure-dist-git 1.15-7
%obsolete paraview-meshio 5.3.5-10
%obsolete pgzero 1.2.1-22
%obsolete platformio 6.1.19-2
%obsolete protonvpn-cli 2.2.12-10
%obsolete pyp2rpm 3.3.10-16
%obsolete python-nipy-doc 1:0.6.1-6
%obsolete python3-Naked 0.1.31-33
%obsolete python3-PyLEMS 0.6.8-6
%obsolete python3-PyQt4 4.12.3-52
%obsolete python3-PyQt4-devel 4.12.3-52
%obsolete python3-PyQt4-webkit 4.12.3-52
%obsolete python3-Pykka 4.2.0-7
%obsolete python3-XStatic-Angular 1:1.5.8.0-33
%obsolete python3-XStatic-Angular-Bootstrap 2.2.0.0-32
%obsolete python3-XStatic-Angular-FileUpload 12.0.4.0-36
%obsolete python3-XStatic-Angular-Gettext 2.1.0.2-37
%obsolete python3-XStatic-Angular-Mock 1.2.1.1-39
%obsolete python3-XStatic-Angular-UUID 0.0.4.0-32
%obsolete python3-XStatic-Angular-Vis 4.16.0.0-29
...
%obsolete python3-XStatic-JQuery-Migrate 1.2.1.1-39
%obsolete python3-XStatic-JQuery-TableSorter 2.14.5.1-39
%obsolete python3-XStatic-JQuery-quicksearch 2.0.3.2-7
%obsolete python3-XStatic-JS-Yaml 3.8.1.0-30
%obsolete python3-XStatic-JSEncrypt 2.3.1.1-31
...
%obsolete python3-XStatic-Spin 1.2.5.2-40
%obsolete python3-XStatic-bootswatch 3.3.7.0-33
%obsolete python3-XStatic-mdi 1.6.50.2-23
%obsolete python3-XStatic-smart-table 1.4.13.2-31
%obsolete python3-XStatic-termjs 0.0.7.0-31
%obsolete python3-adafruit-board-toolkit 1.1.2-7
%obsolete python3-agate 1.13.0-5
%obsolete python3-agate-dbf 0.2.3-8
%obsolete python3-agate-excel 0.4.1-8
%obsolete python3-agate-sql 0.7.2-8
%obsolete python3-aiohttp-negotiate 0.11-32
%obsolete python3-airspeed 0.6.0-11
%obsolete python3-argparse-dataclass 2.0.0-19
%obsolete python3-arpeggio 2.0.2-12
%obsolete python3-atomic-reactor 4.21.0-9
%obsolete python3-autograd 1.8.0-7
%obsolete python3-autograd+scipy 1.8.0-7
%obsolete python3-avocado 112.0-4
%obsolete python3-avocado-plugins-ansible 112.0-4
%obsolete python3-avocado-plugins-golang 112.0-4
%obsolete python3-avocado-plugins-output-html 112.0-4
%obsolete python3-avocado-plugins-result-mail 112.0-4
%obsolete python3-avocado-plugins-result-upload 112.0-4
%obsolete python3-avocado-plugins-resultsdb 112.0-4
%obsolete python3-avocado-plugins-spawner-remote 112.0-4
%obsolete python3-avocado-plugins-varianter-cit 112.0-4
%obsolete python3-avocado-plugins-varianter-pict 112.0-4
%obsolete python3-avocado-plugins-varianter-yaml-to-mux 112.0-4
%obsolete python3-azure-functions-devops-build 0.0.22-20
%obsolete python3-azure-loganalytics 0.1.0-27
%obsolete python3-azure-mgmt-support 6.0.0-15
%obsolete python3-bioframe 0.8.0-8
%obsolete python3-botan2 2.19.5-18
%obsolete python3-bowler 0.9.0-20
%obsolete python3-bowler-docs 0.9.0-20
%obsolete python3-box 7.2.0-4
%obsolete python3-brian2 2.9.0-7
%obsolete python3-bsmschema 0.1.1-6
%obsolete python3-catkin_lint 1.6.22-15
%obsolete python3-chai 1.1.2-41
%obsolete python3-ci-info 0.3.0-7
%obsolete python3-cmake-build-extension 0.6.1-11
%obsolete python3-cmake-build-extension-doc 0.6.1-11
%obsolete python3-conda-inject 1.3.2-13
%obsolete python3-connection-pool 0.0.3-27
%obsolete python3-cradox 2.1.0-28
%obsolete python3-cro 0.0.5.2-13
%obsolete python3-csvkit 2.1.0-2
%obsolete python3-cyipopt 1.5.0-10
%obsolete python3-cyipopt-tests 1.5.0-10
%obsolete python3-dandischema 0.10.3-9
%obsolete python3-datetimerange 1.2.0-15
%obsolete python3-dipy 1.11.0-9
%obsolete python3-django-ipware 4.0.2-17
%obsolete python3-django-rules 3.5.0-5
%obsolete python3-dnfdaemon 0.3.22-12
%obsolete python3-docker-squash 1.1.0-15
%obsolete python3-dpath 2.2.0-13
%obsolete python3-dput 1.21-28
%obsolete python3-efel 5.7.16-7
%obsolete python3-elephant 1.1.1-7
%obsolete python3-etcd 0.5.0~20231031git5aea0fd-8
%obsolete python3-etelemetry 0.3.1-6
%obsolete python3-fields 5.0.0-29
%obsolete python3-fissix 20.8.0-21
%obsolete python3-formulaic 1.1.1-7
%obsolete python3-formulaic+arrow 1.1.1-7
%obsolete python3-formulaic+calculus 1.1.1-7
%obsolete python3-fs 2.4.16-17
%obsolete python3-fsspec+gcs 2026.6.0-2
%obsolete python3-fsspec+gs 2026.6.0-2
%obsolete python3-ftputil 5.2.0-2
...
%obsolete python3-hl7 0.4.5-12
%obsolete python3-hokuyoaist 3.0.2-58
%obsolete python3-hypothesmith 0.3.3-9
%obsolete python3-iep 3.7-38
%obsolete python3-imbalanced-learn 0.14.0-6
%obsolete python3-imbalanced-learn+optional 0.14.0-6
%obsolete python3-intern 1.4.2-6
%obsolete python3-ipython+notebook 8.37.0-12
%obsolete python3-irodsclient 3.3.0-2
%obsolete python3-jschema-to-python 1.2.3-24
%obsolete python3-jsonpath-rw 1.4.0-28
%obsolete python3-junit-xml 1.9^20200222gitba89b41-26
%obsolete python3-jupyter-c-kernel 1.2.2-30
%obsolete python3-klusta 3.0.16-36
%obsolete python3-lazy-ops 0.2.0-22
%obsolete python3-lazyarray 0.6.0-6
%obsolete python3-libNeuroML 0.6.5-8
%obsolete python3-libnl3 3.12.0-3
%obsolete python3-libqtile+wayland 0.33.0-3
%obsolete python3-linuxdoc 20240924-9
%obsolete python3-lqrt 0.3.3-15
%obsolete python3-markdown_2 3.4.4-8
%obsolete python3-matrix-nio 0.25.2-8
%obsolete python3-mbstrdecoder 1.1.3-8
%obsolete python3-meshio 5.3.5-10
%obsolete python3-meshio+all 5.3.5-10
%obsolete python3-microfs 1.3.1-31
%obsolete python3-mock 4.0.3-26
%obsolete python3-modernize 0.8.0-22
%obsolete python3-monotonic 1.6-7
%obsolete python3-more-executors+prometheus 2.11.4-15
%obsolete python3-moss 0.5.0-31
%obsolete python3-mrcfile 1.5.4-7
%obsolete python3-murano-pkg-check 0.3.0-42
%obsolete python3-ncclient 0.7.0-3
%obsolete python3-ncclient+libssh 0.7.0-3
%obsolete python3-neurom 4.0.4-7
%obsolete python3-neurom+plotly 4.0.4-7
%obsolete python3-niaarm 0.4.1-5
%obsolete python3-nikola 8.3.3-5
%obsolete python3-nikola+extras 8.3.3-5
%obsolete python3-nipy 1:0.6.1-6
%obsolete python3-nipy+optional 1:0.6.1-6
%obsolete python3-nispor 1.2.27-7
%obsolete python3-nose2+coverage_plugin 0.15.1-17
%obsolete python3-novaclient-os-networks 0.26-35
%obsolete python3-nudatus 0.0.5-25
%obsolete python3-odcs-client 0.9.0-6
%obsolete python3-odcs-common 0.9.0-6
%obsolete python3-opytimizer 3.1.4-7
%obsolete python3-outdated 0.2.0-22
%obsolete python3-pandas-flavor 0.7.0-4
%obsolete python3-parameterized 0.9.0-18
%obsolete python3-parver 0.5-7
%obsolete python3-pastel 0.2.1-5
%obsolete python3-path-and-address 2.0.1-7
%obsolete python3-pdir2 1.1.0-8
%obsolete python3-pdm-pep517 1.1.4-13
%obsolete python3-pgpdump 1.2.12-35
%obsolete python3-plac 1.4.5-10
%obsolete python3-platformio 6.1.19-2
%obsolete python3-plotly 5.24.1-9
%obsolete python3-poetry-plugin-export 1.10.0-2
%obsolete python3-probeinterface 0.2.28-6
%obsolete python3-pulp 3.3.0-6
%obsolete python3-pulp+highs 3.3.0-6
%obsolete python3-pulp+scip 3.3.0-6
%obsolete python3-pvc 0.3.0-31
%obsolete python3-py-tes 1.1.4-2
%obsolete python3-py27hash 1.1.0-24
%obsolete python3-pyABF 2.3.8-10
%obsolete python3-pyactivetwo 0.1-36
%obsolete python3-pycatch22 0.4.4-16
%obsolete python3-pydotplus 2.0.2-38
%obsolete python3-pyedflib 0.1.42-5
%obsolete python3-pyelectro 0.2.7-11
%obsolete python3-pyfim 6.28-22
%obsolete python3-pygls+ws 2.0.0a5-5
%obsolete python3-pyjwkest 1.4.2-13
%obsolete python3-pylatex 1.4.2-9
%obsolete python3-pylink 0.3.2-41
%obsolete python3-pymatreader 1.2.2-2
%obsolete python3-pynamodb 6.1.0-6
%obsolete python3-pynamodb+signals 6.1.0-6
%obsolete python3-pyprocdev 0.2-36
%obsolete python3-pyqtchart 5.15.5-24
%obsolete python3-pyqtchart-devel 5.15.5-24
%obsolete python3-pyramid_sawing 1.1.3-29
%obsolete python3-pyriemann 0.8-6
%obsolete python3-pyrsistent 0.20.0-18
%obsolete python3-pysdl2 0.9.17-9
%obsolete python3-pytest-runner 4.0-32
%obsolete python3-pytest-subtests 0.15.0-5
%obsolete python3-pytest-sugar 1.1.1-4
%obsolete python3-pyudev-qt4 0.24.3-13
%obsolete python3-pyunicorn 0.8.2-8
%obsolete python3-pyvirtualize 0.10-27
%obsolete python3-pywlroots 0.17.0-10
%obsolete python3-pyxdf 1.17.0-7
...
%obsolete python3-rdopkg 1.7.0-11
%obsolete python3-read-roi 1.6.0-17
%obsolete python3-renderspec 2.2.0-13
%obsolete python3-reretry 0.11.8-19
%obsolete python3-restview 3.0.0-15
%obsolete python3-retryz 0.1.9-35
%obsolete python3-rpmautospec-koji 0.4.0-13
%obsolete python3-saharaclient 4.2.0-11
%obsolete python3-salib 1.5.1-7
%obsolete python3-salib+distributed 1.5.1-7
%obsolete python3-sanlock 4.2.0-4
%obsolete python3-sarif-om 1.0.4-26
%obsolete python3-schedutils 0.6-31
%obsolete python3-sciunit 0.2.8-13
%obsolete python3-shade 1.33.0-20
%obsolete python3-simpleaudio 1.0.4-22
%obsolete python3-sklearn-genetic-opt 0.11.1-17
%obsolete python3-sklearn-genetic-opt+seaborn 0.11.1-17
%obsolete python3-smart-open 7.6.1-2
%obsolete python3-smart-open+all 7.6.1-2
%obsolete python3-smart-open+azure 7.6.1-2
%obsolete python3-smart-open+gcs 7.6.1-2
%obsolete python3-smart-open+http 7.6.1-2
%obsolete python3-smart-open+s3 7.6.1-2
%obsolete python3-smart-open+ssh 7.6.1-2
%obsolete python3-smart-open+webhdfs 7.6.1-2
%obsolete python3-smart-open+zst 7.6.1-2
%obsolete python3-snakemake-executor-plugin-cluster-generic 1.0.9-13
%obsolete python3-snakemake-executor-plugin-cluster-sync 0.1.5-6
%obsolete python3-snakemake-executor-plugin-flux 0.1.1-11
%obsolete python3-snakemake-executor-plugin-kubernetes 0.5.1-5
%obsolete python3-snakemake-executor-plugin-slurm 2.6.1-2
%obsolete python3-snakemake-executor-plugin-slurm-jobstep 0.6.0-2
%obsolete python3-snakemake-executor-plugin-tes 0.1.3-15
%obsolete python3-snakemake-interface-common 1.23.0-2
%obsolete python3-snakemake-interface-executor-plugins 9.4.0-2
%obsolete python3-snakemake-interface-logger-plugins 2.1.0-2
%obsolete python3-snakemake-interface-report-plugins 1.3.0-4
%obsolete python3-snakemake-interface-scheduler-plugins 2.0.2-4
%obsolete python3-snakemake-interface-storage-plugins 1:4.4.1-2
%obsolete python3-snakemake-logger-plugin-rich 0.4.1-2
%obsolete python3-snakemake-storage-plugin-azure 0.4.4-8
%obsolete python3-snakemake-storage-plugin-fs 1.1.3-5
%obsolete python3-snakemake-storage-plugin-ftp 0.1.3-8
%obsolete python3-snakemake-storage-plugin-gcs 1.1.4-8
%obsolete python3-snakemake-storage-plugin-http 0.3.1-3
%obsolete python3-snakemake-storage-plugin-s3 0.3.6-5
%obsolete python3-snakemake-storage-plugin-webdav 0.1.2-10
%obsolete python3-snakemake-storage-plugin-xrootd 1.1.0-3
%obsolete python3-snakemake-storage-plugin-zenodo 0.1.5-8
%obsolete python3-snuggs 1.4.7-25
%obsolete python3-sphinx-hoverxref 1.4.1-8
%obsolete python3-sphinx-sitemap 2.7.2-5
%obsolete python3-strictyaml 1.7.3-16
%obsolete python3-sysrsync 1.1.1-16
%obsolete python3-system-calls 6.13.0-6
%obsolete python3-tensile-devel 7.1.0-5
%obsolete python3-throttler 1.2.3-3
%obsolete python3-toml 0.10.2-26
%obsolete python3-toml-adapt 0.3.4-7
...
%obsolete python3-vsts 0.1.25-22
%obsolete python3-vsts-cd-manager 1.0.2-22
%obsolete python3-wavio 0.0.9-9
%obsolete python3-wtf-peewee 3.0.5-12
%obsolete python3-wult 1.12.48-3
%obsolete python3-yte 1.9.4-3
%obsolete python3-yui 4.2.16-29
%obsolete python3-zarr-checksum 0.4.2-11
%obsolete rabbitvcs-caja 0.19-12
%obsolete rabbitvcs-cli 0.19-12
%obsolete rabbitvcs-nautilus 0.19-12
%obsolete rabbitvcs-nemo 0.19-12
%obsolete rdopkg 1.7.0-11
%obsolete restview 3.0.0-15
%obsolete roca-detect 1.2.12-35
%obsolete snakemake 9.21.1-3
%obsolete snakemake+reports 9.21.1-3
%obsolete sourcextractor++ 1.0.3-5
%obsolete sourcextractor++-devel 1.0.3-5
%obsolete spectrographic 0.9.3-24
%obsolete stats-collect 1.0.59-3
