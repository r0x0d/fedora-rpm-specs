...
License:        MPL-2.0
URL:            https://crates.io/crates/gst-plugin-json
...
# MPL-2.0
# Unlicense OR MIT
License:        (Apache-2.0 OR BSL-1.0) AND (Apache-2.0 OR MIT) AND MIT AND MPL-2.0 AND (Unlicense OR MIT)
# LICENSE.dependencies contains a full license breakdown

%description -n gstreamer1-plugin-json %{_description}

%files       -n gstreamer1-plugin-json
%license LICENSE-MPL-2.0
%license LICENSE.dependencies
%{_libdir}/gstreamer-1.0/libgstjson.so
...
rm -v %{buildroot}/%{_libdir}/gstreamer-1.0/libgstjson.a
# remove unnecessary pkgconfig file
rm -v %{buildroot}/%{_libdir}/pkgconfig/gstjson.pc
