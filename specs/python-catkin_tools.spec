...
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 0.9.4-11
...
* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 0.9.4-7
- Rebuilt for Python 3.14

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.9.4-6
