...
Source20:        https://ctan.math.illinois.edu/systems/texlive/tlnet/archive/zitie.tar.xz
Source21:        https://ctan.math.illinois.edu/systems/texlive/tlnet/archive/zitie.doc.tar.xz
Source22:        https://ctan.math.illinois.edu/systems/texlive/tlnet/archive/zxjafont.tar.xz
Source23:        https://ctan.math.illinois.edu/systems/texlive/tlnet/archive/zxjafont.doc.tar.xz
...
Requires:       texlive-base
Requires:       texlive-kpathsea
Provides:       texlive-c90-doc = %{epoch}:%{version}-%{release}
Obsoletes:      texlive-c90-doc <= 11:%{version}
...
Requires:       texlive-base
Requires:       texlive-kpathsea
Provides:       texlive-zxjafont-doc = %{epoch}:%{version}-%{release}
Obsoletes:      texlive-zxjafont-doc <= 11:%{version}
...
- Update collection from svn65824 to svn78607
- fix -doc provides/obsoletes

* Mon Apr 06 2026 Tom Callaway <spot@fedoraproject.org> - 12:svn65824-5
