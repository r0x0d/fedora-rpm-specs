...
%changelog
* Thu Sep 10 2026 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 4.6.2-17
- Rebuilt for libxml-2.5.4

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 4.6.2-16
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.6.2-15
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 4.6.2-14
- Rebuilt for Python 3.15

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.6.2-13
...
* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 4.6.2-10
