...
%global upstream_version 12.3.7
...
BuildRequires:  (php-composer(phpunit/php-code-coverage) >= 12.3.3    with php-composer(phpunit/php-code-coverage) < 13)
...
Requires:       (php-composer(phpunit/php-code-coverage) >= 12.3.3    with php-composer(phpunit/php-code-coverage) < 13)
