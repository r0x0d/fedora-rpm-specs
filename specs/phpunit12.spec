...
BuildRequires:  (php-composer(phpunit/php-code-coverage) >= 12.3.2    with php-composer(phpunit/php-code-coverage) < 13)
...
BuildRequires:  (php-composer(sebastian/comparator) >= 7.1.0          with php-composer(sebastian/comparator) < 8)
...
BuildRequires:  (php-composer(sebastian/type) >= 6.0.2                with php-composer(sebastian/type) < 7)
...
Requires:       (php-composer(phpunit/php-code-coverage) >= 12.3.2    with php-composer(phpunit/php-code-coverage) < 13)
...
Requires:       (php-composer(sebastian/comparator) >= 7.1.0          with php-composer(sebastian/comparator) < 8)
...
Requires:       (php-composer(sebastian/type) >= 6.0.2                with php-composer(sebastian/type) < 7)
