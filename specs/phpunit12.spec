...
BuildRequires:  (php-composer(phpunit/php-code-coverage) >= 12.2.1    with php-composer(phpunit/php-code-coverage) < 13)
...
Requires:       (php-composer(phpunit/php-code-coverage) >= 12.2.1    with php-composer(phpunit/php-code-coverage) < 13)
