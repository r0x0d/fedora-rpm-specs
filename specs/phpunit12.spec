...
%global gh_commit    19e25c2da3f8071a683ee1e445b0e24bba25de61
...
%global upstream_version 12.2.2
...
BuildRequires:  (php-composer(phpunit/php-code-coverage) >= 12.3.0    with php-composer(phpunit/php-code-coverage) < 13)
...
Requires:       (php-composer(phpunit/php-code-coverage) >= 12.3.0    with php-composer(phpunit/php-code-coverage) < 13)
