...
%package     -n %{name}+preupdate-hook-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+preupdate-hook-devel %{_description}

This package contains library source intended for building other packages which
use the "preupdate-hook" feature of the "%{crate}" crate.

%files       -n %{name}+preupdate-hook-devel
%ghost %{crate_instdir}/Cargo.toml
...
%package     -n %{name}+unbundled-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+unbundled-devel %{_description}

This package contains library source intended for building other packages which
use the "unbundled" feature of the "%{crate}" crate.

%files       -n %{name}+unbundled-devel
%ghost %{crate_instdir}/Cargo.toml
