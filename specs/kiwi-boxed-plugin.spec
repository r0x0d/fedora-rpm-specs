...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.2.57-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Thu Mar 12 2026 Neal Gompa <ngompa@fedoraproject.org> - 0.2.57-1
- Update to 0.2.57

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.2.56-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 0.2.56-2
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Sep 12 2025 Neal Gompa <ngompa@fedoraproject.org> - 0.2.56-1
- Update to 0.2.56

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 0.2.55-2
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Aug 08 2025 Neal Gompa <ngompa@fedoraproject.org> - 0.2.55-1
- Update to 0.2.55

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.2.52-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Thu Jul 10 2025 Python Maint <python-maint@redhat.com> - 0.2.52-2
- Rebuilt for Python 3.14

* Tue Mar 25 2025 Neal Gompa <ngompa@fedoraproject.org> - 0.2.52-1
- Update to 0.2.52
