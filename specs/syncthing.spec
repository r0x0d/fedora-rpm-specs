...
Provides:       bundled(golang(github.com/maruel/panicparse/v2)) = 2.4.0
...
Provides:       bundled(golang(github.com/quic-go/quic-go)) = 0.50.0
...
Provides:       bundled(golang(github.com/shirou/gopsutil/v4)) = 4.25.2
