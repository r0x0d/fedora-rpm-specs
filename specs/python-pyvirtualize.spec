...
Version:        0.10
Release:        26.%{date}git%(c=%commit0; echo ${c:0:7} )%{?dist}
...
%changelog
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 0.10-26.20191018gitdc2d971
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 0.10-25.20191018gitdc2d971
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.10-24.20191018gitdc2d971
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Fri Jun 06 2025 Python Maint <python-maint@redhat.com> - 0.10-23.20191018gitdc2d971
