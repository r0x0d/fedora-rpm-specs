...
%changelog
* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.3.1-4
...
- Fixed janus-plugins-audiobridge's summary.

* Fri Mar 07 2025 Rénich Bon Ćirić - 1.3.1-1
- Updated to v1.3.1.
- Fixed license.
- Updated API version to 2.0.6.

* Wed Dec 18 2024 Rénich Bon Ćirić - 1.3.0-2
- Included GCC as a requirement.
- Switched to using SPDX license names.

* Wed Dec 18 2024 Rénich Bon Ćirić <renich@woralelandia.com> - 1.3.0-1
- Updated to v1.3.0.
- Updated API version to 2.0.5.
- Added the lua-term requirement for the lua plugin.

* Fri Apr 19 2024 Rénich Bon Ćirić <renich@woralelandia.com> - 1.2.2-0
- Updated to v1.2.2.

* Fri Sep 15 2023 Rénich Bon Ćirić <renich@woralelandia.com> - 1.2.0-3
- Labeled the demo directory with httpd_sys_content_t label.

* Thu Sep 14 2023 Rénich Bon Ćirić <renich@woralelandia.com> - 1.2.0.5
...
* Tue Aug 15 2023 Rénich Bon Ćirić <renich@woralelandia.com> - 1.2.0-1
- Updated to v1.2.0.
...
* Wed May 17 2023 Rénich Bon Ćirić <renich@woralelandia.com> - 1.1.3-1
- Updated to v1.1.3.
- Removed voicemail plugin.
- Removed Fedora 36 support.

* Wed Feb 01 2023 Rénich Bon Ćirić <renich@woralelandia.com> - 1.1.2-3
- Removed date from docs package.
- Added make as a build dependency.

* Thu Jan 26 2023 Rénich Bon Ćirić <renich@woralelandia.com> - 1.1.2-2
- Fixed file selection for Fedora 37 and onwards.

* Mon Jan 23 2023 Rénich Bon Ćirić <renich@woralelandia.com> - 1.1.2-1
- Updated to v1.1.2.
- Selectively including files generated by doxygen.
- Removed libcurl patch since upstream included it.

* Mon Jan 16 2023 Rénich Bon Ćirić <renich@woralelandia.com> - 1.1.1-5
- Removed js-jquery explicit requirement from doc.
- Corrected the gstreamer dependency version for tools.

* Wed Jan 04 2023 Rénich Bon Ćirić <renich@woralelandia.com> - 1.1.1-4
- Applied patch to fix build. Upstream ticket is: https://github.com/meetecho/janus-gateway/pull/3138.

* Fri Dec 23 2022 Rénich Bon Ćirić <renich@woralelandia.com> - 1.1.1-3
- Shortened summaries.
- Marked demos and docs as noarch.
- Removed the js-jquery requirement.

* Sun Dec 18 2022 Rénich Bon Ćirić <renich@woralelandia.com> - 1.1.1-2
- Converted remote web resources to local for docs and demos.
- Added a check finally.

* Fri Dec 16 2022 Rénich Bon Ćirić <renich@woralelandia.com> - 1.1.1-1
- Updated to v1.1.1.
- Corrected plugins versions.

* Wed Nov 23 2022 Rénich Bon Ćirić <renich@woralelandia.com> - 1.1.0-5
- Fixed file inclusion in order to avoid duplicates.

* Thu Nov 17 2022 Rénich Bon Ćirić <renich@woralelandia.com> - 1.1.0-4
- Made dependency of janus in plugins more accurate.

* Mon Oct 31 2022 Rénich Bon Ćirić <renich@woralelandia.com> - 1.1.0-3
- Fixed directory ownership.

* Tue Oct 18 2022 Rénich Bon Ćirić <renich@woralelandia.com> - 1.1.0-2
- Re-adding demos and docs in HTML format.

* Mon Oct 03 2022 Rénich Bon Ćirić <renich@woralelandia.com> - 1.0.4-7
- Adding noarch to doc subpackage.
- Removed doc and demos sub-package for now.

* Thu Sep 22 2022 Rénich Bon Ćirić <renich@woralelandia.com> - 1.0.4-6
...
* Wed Sep 21 2022 Rénich Bon Ćirić <renich@woralelandia.com> - 1.0.4-5
- Dividing package into sub-packages.
- Enabled the json-logger.

* Wed Sep 14 2022 Rénich Bon Ćirić <renich@woralelandia.com> - 1.0.4-4
- Using name and version macros in main source declaration.
- Moved sample files into doc directory.

* Tue Aug 30 2022 Rénich Bon Ćirić <renich@woralelandia.com> - 1.0.4-3
...
* Fri Aug 26 2022 Rénich Bon Ćirić <renich@woralelandia.com> - 1.0.4-2
- Added missing BuildRequires for the systemd unit.

* Thu Aug 18 2022 Rénich Bon Ćirić <renich@woralelandia.com> - 1.0.4-1
- first draft
