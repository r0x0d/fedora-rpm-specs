...
%global subpkgs %{murmurhash} %{peano} %{pqueue} %{vectorhashtables}
...
Source3:        https://hackage.haskell.org/package/%{pqueue}/%{pqueue}.tar.gz
Source4:        https://hackage.haskell.org/package/%{vectorhashtables}/%{vectorhashtables}.tar.gz
