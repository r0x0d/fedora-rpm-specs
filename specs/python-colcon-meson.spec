...
%changelog
* Sat Sep 27 2025 Scott K Logan <logans@cottsay.net> - 0.5.0-1
- Update to 0.5.0

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.4.5-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 0.4.5-3
