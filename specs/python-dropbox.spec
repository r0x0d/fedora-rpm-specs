...
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 12.0.2-9
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 12.0.2-8
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 12.0.2-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 12.0.2-6
- Rebuilt for Python 3.14

* Wed Feb 05 2025 Gwyn Ciesla <gwync@protonmail.com> - 12.0.2-5
- Drop BR -t
