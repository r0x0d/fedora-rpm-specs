...
License:        MIT
URL:            https://crates.io/crates/gstreamer-gl-egl-sys
Source:         %{crates_source}

BuildRequires:  cargo-rpm-macros >= 24
BuildRequires:  pkgconfig(gstreamer-gl-egl-1.0) >= 1.14
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-gl-egl-1.0) >= 1.14
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-gl-egl-1.0) >= 1.16
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-gl-egl-1.0) >= 1.18
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-gl-egl-1.0) >= 1.20
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-gl-egl-1.0) >= 1.22
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-gl-egl-1.0) >= 1.28
