...
%define simplified_license %{shrink:
Apache-2.0 AND
MIT AND
...
# While it builds fine as of 0.6.0, nobody needs this on 32-bit, since
# Fedora no longer ships a 32-bit OS variant.
...
%doc TODO
# TODO: rpmlint complains of unused deps, hard to get rid of in Rust projects
#tbtools.aarch64: W: unused-direct-shlib-dependency /usr/bin/tbman /lib64/libm.so.6
#tbtools.aarch64: W: unused-direct-shlib-dependency /usr/bin/tbpd /lib64/libudev.so.1
%{_bindir}/lstb
%{_bindir}/tbadapters
%{_bindir}/tbauth
%{_bindir}/tbdump
