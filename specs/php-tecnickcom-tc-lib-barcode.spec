...
BuildRequires: (php-composer(%{c_vendor}/tc-lib-color) >= 2.4    with php-composer(%{c_vendor}/tc-lib-color) < 3)
...
Requires:       php-gd
Requires:       php-pcre
Requires:      (php-composer(%{c_vendor}/tc-lib-color) >= 2.4    with php-composer(%{c_vendor}/tc-lib-color) < 3)
...
%changelog
* Wed Apr 29 2026 Remi Collet <remi@remirepo.net> - 2.4.36-1
- update to 2.4.36 (no change)
...
* Tue Mar  3 2026 Remi Collet <remi@remirepo.net> - 2.4.27-1
- update to 2.4.27
...
* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.4.18-2
...
* Mon Apr 28 2025 Remi Collet <remi@remirepo.net> - 2.4.5-1
- update to 2.4.5 (no change)
