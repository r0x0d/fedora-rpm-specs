...
Conflicts: %{majorname}-private-libs
...
# postgresql stream
Provides: %{majorname}-server-any
Conflicts: %{majorname}-server
...
Conflicts: %{majorname}-server-devel
...
Conflicts: %{majorname}-test-rpm-macros

%if %?postgresql_default
Obsoletes: postgresql%{majorversion}%-test-rpm-macros
%else
Provides: %{majorname}%-test-rpm-macros = %precise_version
%endif
...
Conflicts: %{majorname}-upgrade-devel
...
Conflicts: %{majorname}-plpython3

%obsoletes_postgresqlXX_if_default plpython3
...
- Remove libXML patches - not needed anymore

* Mon Aug 12 2024 Jitka Plesnikova <jplesnik@redhat.com> - 15.5-9
- Fix test for Perl 5.40

* Tue Jul 23 2024 Lumír Balhar <lbalhar@redhat.com> - 15.5-8
- Add new systemtap-sdt-dtrace to build deps

* Fri Jul 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 15.5-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Wed Jun 12 2024 Jitka Plesnikova <jplesnik@redhat.com> - 15.5-6
- Perl 5.40 rebuild

* Fri Jun 07 2024 Python Maint <python-maint@redhat.com> - 15.5-5
...
* Mon Nov 27 2023 Filip Janus <fjanus@redhat.com> - 15.5-1
- Initial import of demodularized version
- Update upgrade server to 14.10
- Update to 15.5

* Wed Oct 25 2023 Filip Janus <fjanus@redhat.com> - 15.4-2
