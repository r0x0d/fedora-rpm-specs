...
%global crate gstreamer-net-sys

Name:           rust-gstreamer-net-sys
Version:        0.25.0
Release:        %autorelease
Summary:        FFI bindings to libgstnet-1.0

License:        MIT
URL:            https://crates.io/crates/gstreamer-net-sys
Source:         %{crates_source}

BuildRequires:  cargo-rpm-macros >= 24
BuildRequires:  pkgconfig(gstreamer-net-1.0) >= 1.14
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-net-1.0) >= 1.14
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-net-1.0) >= 1.16
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-net-1.0) >= 1.18
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-net-1.0) >= 1.20
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-net-1.0) >= 1.22
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-net-1.0) >= 1.24
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-net-1.0) >= 1.28
