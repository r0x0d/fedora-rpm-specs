...
* Thu May 07 2026 Tomáš Hrnčiar <thrnciar@redhat.com> - 2.2.6-32
...
* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 2.2.6-27
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.2.6-26
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jul 14 2025 Ján ONDREJ (SAL) <ondrejj(at)salstar.sk> - 2.2.6-25
- Remove setuptools dependency and add buildrequires generator

* Sat Jun 07 2025 Python Maint <python-maint@redhat.com> - 2.2.6-24
- Rebuilt for Python 3.14

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.2.6-23
