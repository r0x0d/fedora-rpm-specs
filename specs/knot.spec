...
%changelog
* Tue Sep 08 2026 Jan Včelák <jvcelak@fedoraproject.org> - 3.6.0-1
- Update to 3.6.0

* Mon Sep 07 2026 Jan Včelák <jvcelak@fedoraproject.org> - 3.5.8-1
- Update to 3.5.8 (security fixes in XDP, DDNS, and TSIG)

* Tue Aug 18 2026 Jan Včelák <jvcelak@fedoraproject.org> - 3.5.7-1
- Update to 3.5.7 (security fixes)

* Sun Aug 02 2026 Jan Včelák <jvcelak@fedoraproject.org> - 3.5.6-1
- Update to 3.5.6 (security fix for ACL evaluation)

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.5.5-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Mon Jun 22 2026 Jan Včelák <jvcelak@fedoraproject.org> - 3.5.5-1
- Update to 3.5.5
