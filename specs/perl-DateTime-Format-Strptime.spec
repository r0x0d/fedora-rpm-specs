...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1:1.80-3
...
- Update to 1.80 (rhbz#2419653)
  - Fix the parse_datetime docs to state that it returns either an empty list
    of undef when it cannot parse the given string, depending on the context;
    previously, the docs said it always returned undef, which is not true
    (GH#33)
