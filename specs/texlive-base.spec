...
%define __texlive_path          ^%{_texdir}/texmf-dist/.*\\.(4ht|afm|bbx|bg2|bst|bug|cbx|cfg|clo|cls|csv|cnf|dat|dbx|def|enc|eps|fd|icc|ini|lbx|ldf|lua|map|mf|mp|otf|pfa|pfb|pro|sty|tex|rfm|ttf|vf)$
