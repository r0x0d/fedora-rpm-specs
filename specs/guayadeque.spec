...
%if 0%{?usesnapshot}
Version:        0.6.2
Release:        0.8.beta6.git%{shortcommit0}%{dist}
%else
Version:        0.7.5
Release:        5%{?dist}
%endif
...
%changelog
* Sun Mar 22 2026 Björn Esser <besser82@fedoraproject.org> - 0.7.5-5
- Rebuild (jsoncpp)

* Sun Jan 25 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 0.7.5-4
- Rebuilt for https://fedoraproject.org/wiki/Changes/TagLib2

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.7.5-3
...
* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.7.2-2
...
* Thu Feb 27 2025 Björn Esser <besser82@fedoraproject.org> - 0.7.0-2
- Rebuild (jsoncpp)

* Sun Feb 23 2025 Martin Gansser <martinkg@fedoraproject.org> - 0.7.0-1
- Update to 0.7.0

* Fri Feb 21 2025 Martin Gansser <martinkg@fedoraproject.org> - 0.6.5-1
- Update to 0.6.5

* Mon Feb 03 2025 Martin Gansser <martinkg@fedoraproject.org> - 0.6.4-1
- Update to 0.6.4

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.6.2-2
