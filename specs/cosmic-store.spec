...
%global commit da8c64229f43164c6fa6613087f2284d3caf1721
%global shortcommit %{sub %{commit} 1 7}
%global commitdatestring 2024-09-24 09:20:42 -0600
...
License:        (MIT OR Apache-2.0 OR CC0-1.0) AND (Apache-2.0 OR MIT) AND BSD-2-Clause AND BSD-3-Clause AND CC0-1.0 AND (Apache-2.0  OR  MIT) AND (MIT OR Apache-2.0 OR Zlib) AND (Unlicense OR MIT) AND Zlib AND BSL-1.0 AND (Apache-2.0 OR BSL-1.0) AND MPL-2.0 AND (Zlib OR Apache-2.0 OR MIT) AND Apache-2.0 AND (BSD-2-Clause OR Apache-2.0 OR MIT) AND ISC AND (MIT OR Apache-2.0) AND (MIT OR Zlib OR Apache-2.0) AND (Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT) AND ((Apache-2.0 OR MIT) AND BSD-3-Clause) AND (Apache-2.0 OR ISC OR MIT) AND (0BSD OR MIT OR Apache-2.0) AND (BSD-3-Clause OR MIT OR Apache-2.0) AND MIT AND Unicode-3.0
