...
%changelog
* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 4.5-2
...
* Wed Aug  28 2024 Miroslav Suchý <msuchy@redhat.com> - 4.4-5
- convert license to SPDX

* Wed Jul 17 2024 Fedora Release Engineering <releng@fedoraproject.org> - 4.4-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Mon Jun 17 2024 Michael Schwendt <mschwendt@fedoraproject.org> - 4.4-3
- Review spec file, and incorporate suggestions from Thomas Lange.

* Fri Jun 14 2024 Michael Schwendt <mschwendt@fedoraproject.org> - 4.4-2
- If building with autotools, temporarily install with LIB_PATCH=0 because of
  a bug in the buildsys macros in the released tarball.

* Wed Jun 12 2024 Michael Schwendt <mschwendt@fedoraproject.org> - 4.4-1
- Update to 4.4 release.

* Sun May  5 2024 Michael Schwendt <mschwendt@fedoraproject.org> - 4.4-0.3.beta1
...
* Wed Jul 20 2022 Fedora Release Engineering <releng@fedoraproject.org> - 4.1-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Wed Jan 19 2022 Fedora Release Engineering <releng@fedoraproject.org> - 4.1-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Wed Jul 21 2021 Fedora Release Engineering <releng@fedoraproject.org> - 4.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Tue Mar 30 2021 Jonathan Wakely <jwakely@redhat.com> - 4.1-2
...
* Fri Oct 23 2020 Michael Schwendt <mschwendt@fedoraproject.org> - 4.0.5-3
- External libguess not used anymore, drop BR.
...
* Sat Mar 28 2020 Michael Schwendt <mschwendt@fedoraproject.org> - 4.0-0.2
- (fedora copr only)
- Update to 4.0.
