...
# End cabal-rpm setup
cabal-tweak-dep-ver aeson '< 2.2' '< 2.3'
...
%{buildroot}%{_bindir}/dhall-to-json --fish-completion-script dhall-to-json > %{buildroot}%{fish_completions_dir}/dhall-to-json
%{buildroot}%{_bindir}/dhall-to-json --zsh-completion-script dhall-to-json | sed s/filenames/default/ > %{buildroot}%{zsh_completions_dir}/_dhall-to-json
...
%{buildroot}%{_bindir}/dhall-to-yaml --fish-completion-script dhall-to-yaml > %{buildroot}%{fish_completions_dir}/dhall-to-yaml
%{buildroot}%{_bindir}/dhall-to-yaml --zsh-completion-script dhall-to-yaml | sed s/filenames/default/ > %{buildroot}%{zsh_completions_dir}/_dhall-to-yaml
...
%{buildroot}%{_bindir}/json-to-dhall --fish-completion-script json-to-dhall > %{buildroot}%{fish_completions_dir}/json-to-dhall
%{buildroot}%{_bindir}/json-to-dhall --zsh-completion-script json-to-dhall | sed s/filenames/default/ > %{buildroot}%{zsh_completions_dir}/_json-to-dhall
...
%{fish_completions_dir}/dhall-to-json
%{fish_completions_dir}/dhall-to-yaml
%{fish_completions_dir}/json-to-dhall
%{zsh_completions_dir}/_dhall-to-json
%{zsh_completions_dir}/_dhall-to-yaml
%{zsh_completions_dir}/_json-to-dhall
