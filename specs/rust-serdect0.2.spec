...
# * Update hex-literal dev-dependency to v1
# * Update serde-json-core dev-dependency to 0.6
# * Update toml dev-dependency to v1
Patch:          serdect-fix-metadata.diff
