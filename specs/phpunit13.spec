...
BuildRequires:  (php-composer(phpunit/php-code-coverage) >= 14.3.3    with php-composer(phpunit/php-code-coverage) < 15)
...
Requires:       (php-composer(phpunit/php-code-coverage) >= 14.3.3    with php-composer(phpunit/php-code-coverage) < 15)
...
%changelog
* Tue Sep 15 2026 Remi Collet <remi@remirepo.net> - 13.3.4-1
- update to 13.3.4
- raise dependency on phpunit/php-code-coverage 14.3.3

* Wed Sep  9 2026 Remi Collet <remi@remirepo.net> - 13.3.3-1
- update to 13.3.3
- raise dependency on phpunit/php-code-coverage 14.3.2
- raise dependency on sebastian/diff 9.0.1
