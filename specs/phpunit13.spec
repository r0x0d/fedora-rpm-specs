...
BuildRequires:  (php-composer(phpunit/php-code-coverage) >= 14.1.9    with php-composer(phpunit/php-code-coverage) < 15)
...
Requires:       (php-composer(phpunit/php-code-coverage) >= 14.1.9    with php-composer(phpunit/php-code-coverage) < 15)
