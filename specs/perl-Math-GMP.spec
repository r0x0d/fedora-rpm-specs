...
%changelog
* Wed Jul 22 2026 Jitka Plesnikova <jplesnik@redhat.com> - 2.25-17
- Perl 5.44 rebuild

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.25-16
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.25-15
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.25-14
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jul 07 2025 Jitka Plesnikova <jplesnik@redhat.com> - 2.25-13
- Perl 5.42 rebuild

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.25-12
...
* Mon Jun 10 2024 Jitka Plesnikova <jplesnik@redhat.com> - 2.25-9
- Perl 5.40 rebuild

* Thu Jan 25 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.25-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Sun Jan 21 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.25-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Thu Jul 20 2023 Fedora Release Engineering <releng@fedoraproject.org> - 2.25-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_39_Mass_Rebuild

* Tue Jul 11 2023 Jitka Plesnikova <jplesnik@redhat.com> - 2.25-5
- Perl 5.38 rebuild

* Fri Jan 20 2023 Fedora Release Engineering <releng@fedoraproject.org> - 2.25-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_38_Mass_Rebuild

* Fri Jul 22 2022 Fedora Release Engineering <releng@fedoraproject.org> - 2.25-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Mon May 30 2022 Jitka Plesnikova <jplesnik@redhat.com> - 2.25-2
- Perl 5.36 rebuild

* Tue Mar 15 2022 Paul Howarth <paul@city-fan.org> - 2.25-1
- Update to 2.25
  - Refactoring
  - Test::Builder overloading workaround (GH#9)

* Fri Jan 21 2022 Fedora Release Engineering <releng@fedoraproject.org> - 2.24-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Wed Nov 17 2021 Paul Howarth <paul@city-fan.org> - 2.24-1
- Update to 2.24
  - Tests and better documentation for bnok() (Binomial)
  - Eliminate warning about not_here() in GMP.xs

* Mon Nov  8 2021 Paul Howarth <paul@city-fan.org> - 2.23-1
- Update to 2.23
  - Add support for bmulf() to multiply by a floating point number
  - Add support for bnok() (Binomial)

* Tue Sep 21 2021 Paul Howarth <paul@city-fan.org> - 2.22-1
- Update to 2.22
  - Signature files are generated unreliably and are an ongoing source of bug
    reports; as a result, we decided to axe them altogether

* Mon Sep 13 2021 Paul Howarth <paul@city-fan.org> - 2.21-1
- Update to 2.21
  - Additional documentation on the pitfalls of division by zero (GH#5)
- Use %%license unconditionally

* Thu Jul 22 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.20-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Fri May 21 2021 Jitka Plesnikova <jplesnik@redhat.com> - 2.20-5
- Perl 5.34 rebuild

* Wed Jan 27 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.20-4
