...
%ghc_lib_subpackage -d -l BSD-3-Clause template-haskell-2.20.0.0
...
%changelog
* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 9.6.7-26
...
* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 9.6.6-21
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Mon Jul  1 2024 Jens Petersen <petersen@redhat.com> - 9.6.6-20
- https://downloads.haskell.org/ghc/9.6.6/docs/users_guide/9.6.6-notes.html
  with directory-1.3.8.5
- switch to ld.bfd from ld.gold for Fedora

* Sat Jun 15 2024 Jens Petersen <petersen@redhat.com> - 9.6.5-19
- explicit requires binutils-gold
- ppc64le: NCG fix for ccall target hints (Peter Trommler, #2172771)

* Wed Apr 17 2024 Jens Petersen <petersen@redhat.com> - 9.6.5-18
- https://downloads.haskell.org/ghc/9.6.5/docs/users_guide/9.6.5-notes.html
- bumps to base, Cabal, directory, filepath, process
...
* Wed Jan 18 2023 Jens Petersen <petersen@redhat.com> - 9.6.0.20230111-1
- 9.6.1-alpha1
- derived from the ghc9.4 package
