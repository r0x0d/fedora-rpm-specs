...
%changelog
* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 2.9.2-8
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.9.2-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 2.9.2-6
- Rebuilt for Python 3.15

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.9.2-5
...
* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.9.2-2
