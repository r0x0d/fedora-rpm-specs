...
* Wed Jun 03 2026 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-42
- Rebuilt for new VDR 2.8.2 API version 13

* Mon Mar 23 2026 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-41
- Rebuilt for new VDR 2.8.1 API version 12

* Mon Feb 09 2026 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-40
- Rebuilt for new VDR API version 2.7.9

* Mon Jan 26 2026 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-39
- Rebuilt for new VDR API version 2.7.8

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.4.0-38
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jul 25 2025 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-37
- Rebuilt for new VDR API version 2.7.7

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.4.0-36
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sat Jun 21 2025 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-35
- Rebuilt for new VDR API version 2.7.6

* Tue May 27 2025 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-34
- Rebuilt for new VDR API version 2.7.5

* Fri Feb 28 2025 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-33
- Rebuilt for new VDR API version 2.7.4

* Sun Jan 19 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.4.0-32
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Wed Oct 09 2024 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-31
- Rebuilt for new VDR API version 2.7.2
- Add 0002-femon-Removal-of-deprecated-interface-functions.patch
