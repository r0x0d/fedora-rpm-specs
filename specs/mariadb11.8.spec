...
%changelog
* Thu Sep 10 2026 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3:11.8.8-101
- Rebuilt for libxml-2.5.4

* Tue Jul 21 2026 Michal Schorm <mschorm@redhat.com> - 3:11.8.8-100
- Disable the 'distribution default' in MariaDB 11.8 in this package
- Enable the 'distribution default' in MariaDB 12.3 (package 'mariadb12.3')

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3:11.8.8-4
...
* Tue Feb 03 2026 Michal Schorm <mschorm@redhat.com> - 3:11.8.5-100
- Disable the 'distribution default' in MariaDB 10.11 (package 'mariadb10.11')
- Enable the 'distribution default' in MariaDB 11.8 in this package

* Sat Jan 24 2026 Michal Schorm <mschorm@redhat.com> - 3:11.8.5-4
- Fedora 44 change: Remove 'community-mysql' names

* Sat Jan 24 2026 Marcin Juszkiewicz <mjuszkiewicz@redhat.com> - 3:11.8.5-3
- Mark RISC-V64 as 64-bit architecture

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3:11.8.5-2
...
* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3:11.8.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 17 2025 Michal Schorm <mschorm@redhat.com> - 3:11.8.2-1
- Rebase to 11.8 major version

* Mon Jun 16 2025 Michal Schorm <mschorm@redhat.com> - 3:11.4.5-1
- Rebase to 11.4 major version
