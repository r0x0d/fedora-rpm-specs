# Run optional test
# Dancer2::Session::Sereal not yet packaged, bug #2457820
%bcond_with perl_Dancer2_Plugin_LogReport_enables_optional_test
...
BuildRequires:  perl(Log::Report) >= 1.45
...
BuildRequires:  perl(Dancer2::Session::Sereal) >= 0.003
...
Requires:       perl(Dancer2::Session::Sereal) >= 0.003
