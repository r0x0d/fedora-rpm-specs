...
%changelog
* Mon Mar 23 2026 Martin Gansser <martinkg@fedoraproject.org> - 1.2.10-1
- Rebuilt for new VDR 2.8.1 API version 12
- Update to 1.2.10

* Mon Feb 09 2026 Martin Gansser <martinkg@fedoraproject.org> - 1.2.9-4
- Rebuilt for new VDR API version 2.7.9

* Mon Jan 26 2026 Martin Gansser <martinkg@fedoraproject.org> - 1.2.9-3
- Rebuilt for new VDR API version 2.7.8

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.2.9-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Aug 25 2025 Martin Gansser <martinkg@fedoraproject.org> - 1.2.9-1
- Update to 1.2.9

* Fri Jul 25 2025 Martin Gansser <martinkg@fedoraproject.org> - 1.2.8-4
- Rebuilt for new VDR API version 2.7.7

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.2.8-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sat Jun 21 2025 Martin Gansser <martinkg@fedoraproject.org> - 1.2.8-2
- Rebuilt for new VDR API version 2.7.6

* Fri May 30 2025 Martin Gansser <martinkg@fedoraproject.org> - 1.2.8-1
- Update to 1.2.8

* Tue May 27 2025 Martin Gansser <martinkg@fedoraproject.org> - 1.2.7-2
- Rebuilt for new VDR API version 2.7.5

* Fri Apr 25 2025 Martin Gansser <martinkg@fedoraproject.org> - 1.2.7-1
- Update to 1.2.6

* Fri Feb 28 2025 Martin Gansser <martinkg@fedoraproject.org> - 1.2.6-2
- Rebuilt for new VDR API version 2.7.4

* Thu Jan 23 2025 Martin Gansser <martinkg@fedoraproject.org> - 1.2.6-1
- Update to 1.2.6

* Sun Jan 19 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.2.5-2
