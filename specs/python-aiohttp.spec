...
# Disable the blockbuster fixture when the module is not importable
# https://github.com/aio-libs/aiohttp/pull/11367
# Rebased on 3.12.15.
Patch:          0001-Disable-the-blockbuster-fixture-when-the-module-is-n.patch

# We have reserved patch numbers 1000+ for 32-bit patches. The patches are
# always included in the source RPM, but are conditionally applied based on the
# build architecture.

# Downstream-only, for 32-bit: do not test against isal zlib backend
#
# The ISA-L library itself does not support 32-bit architectures.
#
# Applies on top of the patch for PR#11367.
Patch1000:      0002-Downstream-only-for-32-bit-do-not-test-against-isal-.patch
