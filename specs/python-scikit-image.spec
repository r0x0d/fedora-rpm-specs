...
# tar cJvf scikit-image-data-$(date +%Y%m%d).tar.xz -C python-scikit-image-0.26.0-build/scikit-image-0.26.0/scikit-image/0.26.0 .
Source1: scikit-image-data-20260521.tar.xz
...
# Do not stop pytest at 5 failures
sed -i -e 's/, "--maxfail=[0-9]*"//' pyproject.toml
...
%install
%pyproject_install
%pyproject_save_files skimage skimage2
...
%pytest -v \
  ...
  --deselect="tests/skimage/data/test_data.py::test_lily_multichannel" \
  --deselect="tests/skimage/data/test_data.py::test_skin" \
  --deselect="tests/skimage/data/test_data.py::test_vortex" \
  --deselect="tests/skimage/io/test_plugin.py::test_deprecation_warnings_on_plugin_funcs[call_plugin-args1]" \
  --deselect="tests/skimage/registration/test_masked_phase_cross_correlation.py::test_masked_registration_3d_contiguous_mask" \
  --deselect="tests/skimage/restoration/test_restoration.py::test_richardson_lucy_filtered[float32-float16]" \
  --deselect="tests/skimage/restoration/test_restoration.py::test_richardson_lucy_filtered[float32-float32]" \
  --deselect="tests/skimage/restoration/test_restoration.py::test_richardson_lucy_filtered[float32-float64]" \
  --deselect="tests/skimage/restoration/test_restoration.py::test_richardson_lucy_filtered[float64-float16]" \
  --deselect="tests/skimage/restoration/test_restoration.py::test_richardson_lucy_filtered[float64-float32]" \
  --deselect="tests/skimage/restoration/test_restoration.py::test_richardson_lucy_filtered[float64-float64]" \
%ifarch riscv64
  --deselect="tests/skimage/measure/test_moments.py::test_analytical_moments_calculation[2-1-float32]" \
%endif
%ifarch s390x
  --deselect="tests/skimage/io/test_pil.py::test_all_mono" \
  --deselect="tests/skimage/measure/test_fit.py::test_ellipse_parameter_stability[angle45]" \
%endif
  tests/skimage
%endif
...
%changelog
* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 0.26.0-4
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.26.0-3
...
* Tue Aug 19 2025 Sergio Pascual <sergiopr@fedoraproject.org> - 0.25.2-7
