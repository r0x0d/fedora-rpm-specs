...
%changelog
* Tue Oct 22 2024 Thomas Moschny <thomas.moschny@gmx.de> - 2.5.1-1
- Update to 2.5.1.

* Tue Oct 22 2024 Thomas Moschny <thomas.moschny@gmx.de> - 2.5.0-1
- Update to 2.5.0.

* Fri Jul 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.4.13-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Fri Jun 07 2024 Python Maint <python-maint@redhat.com> - 2.4.13-2
- Rebuilt for Python 3.13

* Thu Apr  4 2024 Thomas Moschny <thomas.moschny@gmx.de> - 2.4.13-1
- Update to 2.4.13.

* Fri Jan 26 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.4.12-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Mon Jan 22 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.4.12-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild
...
* Fri Jul 21 2023 Fedora Release Engineering <releng@fedoraproject.org> - 2.4.7-3
...
* Fri Jan 20 2023 Fedora Release Engineering <releng@fedoraproject.org> - 2.4.6-2
...
* Mon Jun 13 2022 Python Maint <python-maint@redhat.com> - 2.4.3-2
- Rebuilt for Python 3.11

* Sat May 28 2022 Thomas Moschny <thomas.moschny@gmx.de> - 2.4.3-1
- Update to 2.4.3.

* Fri Jan 21 2022 Fedora Release Engineering <releng@fedoraproject.org> - 2.4.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Sun Dec  5 2021 Thomas Moschny <thomas.moschny@gmx.de> - 2.4.2-1
- Update to 2.4.2.

* Thu Aug 26 2021 Thomas Moschny <thomas.moschny@gmx.de> - 2.4.1-1
- Update to 2.4.1.
...
* Wed Jan 27 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.3.10-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Sun Oct 25 2020 Thomas Moschny <thomas.moschny@gmx.de> - 2.3.10-1
- Update to 2.3.10.
