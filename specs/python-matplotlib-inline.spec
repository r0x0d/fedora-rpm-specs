...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.2.2-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 0.2.2-2
- Rebuilt for Python 3.15

* Mon May 11 2026 Lumír Balhar <lbalhar@redhat.com> - 0.2.2-1
- Update to 0.2.2 (rhbz#2468324)

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.2.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Oct 24 2025 Lumír Balhar <lbalhar@redhat.com> - 0.2.1-1
- Update to 0.2.1 (rhbz#2406024)
