...
%changelog
* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.38.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 1.38.0-2
- Rebuilt for Python 3.15

* Tue Jan 13 2026 Adrien Vergé - 1.38.0-1
...
* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 1.37.1-4
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.37.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 1.37.1-2
- Rebuilt for Python 3.14

* Sun May 04 2025 Adrien Vergé - 1.37.1-1
- Update to latest upstream version

* Sun Mar 23 2025 Adrien Vergé - 1.37.0-1
- Update to latest upstream version

* Mon Mar 17 2025 Adrien Vergé - 1.36.2-1
- Update to latest upstream version

* Tue Mar 11 2025 Adrien Vergé - 1.36.0-1
- Update to latest upstream version
...
* Fri Feb 16 2024 Adrien Vergé - 1.35.1-1
- Update to latest upstream version

* Thu Feb 15 2024 Adrien Vergé - 1.35.0-1
- Update to latest upstream version

* Tue Feb 06 2024 Adrien Vergé - 1.34.0-1
- Update to latest upstream version

* Sat Jan 27 2024 Fedora Release Engineering <releng@fedoraproject.org> - 1.33.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Thu Nov 09 2023 Adrien Vergé - 1.33.0-1
- Update to latest upstream version
...
* Mon May 22 2023 Adrien Vergé - 1.32.0-1
- Update to latest upstream version

* Fri Apr 21 2023 Adrien Vergé - 1.31.0-1
- Update to latest upstream version

* Fri Apr 14 2023 Adrien Vergé - 1.30.0-2
- Update 'check' step to stop using setup.py

* Wed Mar 22 2023 Adrien Vergé - 1.30.0-1
- Update to latest upstream version

* Sat Jan 21 2023 Fedora Release Engineering <releng@fedoraproject.org> - 1.29.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_38_Mass_Rebuild

* Tue Jan 10 2023 Adrien Vergé - 1.29.0-1
- Update to latest upstream version

* Mon Sep 12 2022 Adrien Vergé - 1.28.0-1
- Update to latest upstream version

* Sat Jul 23 2022 Fedora Release Engineering <releng@fedoraproject.org> - 1.27.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Fri Jul 08 2022 Adrien Vergé - 1.27.1-1
- Update to latest upstream version

* Fri Jul 08 2022 Adrien Vergé - 1.27.0-1
- Update to latest upstream version
...
* Mon Aug 12 2019 Adrien Vergé - 1.17.0-1
- Update to latest upstream version

* Sat Jul 27 2019 Fedora Release Engineering <releng@fedoraproject.org> - 1.16.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_31_Mass_Rebuild

* Fri Jun 7 2019 Adrien Vergé - 1.16.0-1
- Update to latest upstream version

* Mon Feb 11 2019 Adrien Vergé - 1.15.0-1
- Update to latest upstream version
...
* Mon Jan 14 2019 Adrien Vergé - 1.14.0-1
- Update to latest upstream version

* Wed Nov 14 2018 Adrien Vergé - 1.13.0-1
- Update to latest upstream version

* Wed Oct 17 2018 Adrien Vergé - 1.12.1-1
- Update to latest upstream version

* Thu Oct 4 2018 Adrien Vergé - 1.12.0-1
- Update to latest upstream version
...
* Sun Apr 29 2018 Adrien Vergé - 1.11.1-1
- Update to latest upstream version

* Wed Feb 21 2018 Adrien Vergé - 1.11.0-1
- Update to latest upstream version

* Fri Feb 09 2018 Fedora Release Engineering <releng@fedoraproject.org> - 1.10.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_28_Mass_Rebuild

* Sun Nov 5 2017 Adrien Vergé - 1.10.0-1
- Update to latest upstream version

* Mon Oct 16 2017 Adrien Vergé - 1.9.0-1
- Update to latest upstream version

* Thu Jul 27 2017 Fedora Release Engineering <releng@fedoraproject.org> - 1.8.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_27_Mass_Rebuild

* Wed Jul 12 2017 Adrien Vergé - 1.8.1-1
- Update to latest upstream version
- Update dependencies

* Tue Apr 25 2017 Adrien Vergé - 1.7.0-1
- Update to latest upstream version

* Sun Feb 26 2017 Adrien Vergé - 1.6.1-1
- Update to latest upstream version
...
* Wed Nov 30 2016 Adrien Vergé - 1.6.0-1
- Update to latest upstream version

* Sat Oct 8 2016 Adrien Vergé - 1.5.0-1
- Update to latest upstream version

* Tue Sep 27 2016 Adrien Vergé - 1.4.1-1
- Update to latest upstream version

* Mon Sep 19 2016 Adrien Vergé - 1.4.0-1
- Update to latest upstream version

* Tue Jul 19 2016 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 1.3.2-2
- https://fedoraproject.org/wiki/Changes/Automatic_Provides_for_Python_RPM_Packages

* Tue Jun 28 2016 Adrien Vergé - 1.3.2-1
- Update to latest upstream version

* Mon Jun 27 2016 Adrien Vergé - 1.3.0-1
- Update to latest upstream version

* Fri Jun 24 2016 Adrien Vergé - 1.2.2-1
- Update to latest upstream version

* Fri Mar 25 2016 Adrien Vergé - 1.2.1-1
- Update to latest upstream version
- Justify summary

* Mon Mar 7 2016 Adrien Vergé - 1.2.0-1
- Update to latest upstream version
