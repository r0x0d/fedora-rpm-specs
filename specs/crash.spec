...
%changelog
* Fri Apr 24 2026 Tao Liu <ltao@redhat.com> - 9.0.2-1
- Rebase to upstream crash 9.0.2

* Wed Mar 11 2026 Lianbo Jiang <lijiang@redhat.com> - 9.0.1-6
- Fix crash.spec error

* Wed Mar 11 2026 Lianbo Jiang <lijiang@redhat.com> - 9.0.1-5
- Update to the latest commit 95c1b0a1ddee ("Fix for "help -r/-D" to display register values and notes[]")
