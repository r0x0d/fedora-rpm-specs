...
%package     -n %{name}+libwayland_1_22-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+libwayland_1_22-devel %{_description}

This package contains library source intended for building other packages which
use the "libwayland_1_22" feature of the "%{crate}" crate.

%files       -n %{name}+libwayland_1_22-devel
%ghost %{crate_instdir}/Cargo.toml
