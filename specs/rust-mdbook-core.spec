...
%global crate mdbook-core

Name:           rust-mdbook-core
Version:        0.5.3
Release:        %autorelease
Summary:        Base support library for mdbook, intended for internal use only

License:        MPL-2.0
URL:            https://crates.io/crates/mdbook-core
