...
BuildRequires:  (php-composer(sebastian/global-state) >= 5.0.7        with php-composer(sebastian/global-state) <  6)
...
Requires:       (php-composer(sebastian/global-state) >= 5.0.7        with php-composer(sebastian/global-state) <  6)
