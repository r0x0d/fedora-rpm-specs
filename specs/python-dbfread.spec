...
Version:        2.0.7
Release:        38.git%{shortcommit}%{?dist}
...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.7-38.git300b2d7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 2.0.7-37.git300b2d7
- Rebuilt for Python 3.15

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.7-36.git300b2d7
...
* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.7-30.git300b2d7
