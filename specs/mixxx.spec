...
%changelog
* Thu Sep 03 2026 Dominik Mierzejewski <dominik@greysector.net> - 2.5.6-6
- Rebuilt for FFmpeg 9

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.5.6-5
...
* Thu Apr 16 2026 Jan Grulich <jgrulich@redhat.com> - 2.5.6-2
- Rebuild (qt6)

* Tue Mar 31 2026 Dominik Mierzejewski <dominik@greysector.net> - 2.5.6-1
- update to 2.5.6 (resolves rhbz#2451020)
...
* Tue Nov 04 2025 Dominik Mierzejewski <dominik@greysector.net> - 2.5.3-3
- BuildRequires cannot be archful

* Sun Nov 02 2025 Dominik Mierzejewski <dominik@greysector.net> - 2.5.3-2
- Use generic build dependencies
- Stop disabling precompiled headers, it was fixed in 2.4.0
- Stop turning compiler warnings into errors
- Adjust FAAD2 build-and runtime requirements to -libs only
- Review licenses and use SPDX identifiers
