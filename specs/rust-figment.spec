...
# don't generate a superfluous dependency on /usr/bin/bash
rm -rv scripts
%cargo_prep

%generate_buildrequires
%cargo_generate_buildrequires -f env,json,test,toml,yaml

%build
%cargo_build -f env,json,test,toml,yaml

%install
%cargo_install -f env,json,test,toml,yaml

%if %{with check}
%check
%cargo_test -f env,json,test,toml,yaml
%endif
