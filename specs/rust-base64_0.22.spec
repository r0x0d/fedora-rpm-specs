...
# * Update rstest to 0.13, rstest_reuse to 0.7
# * Drop the clap and strum dev-dependencies and the exmaple that would require
#   them in order to avoid depending on additional compat packages.
