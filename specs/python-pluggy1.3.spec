...
This package contains pluggy 1.3.x for compatibility reasons.
Use pluggy 1.4+ instead if at all possible.}

%description %_description


%package -n python3-pluggy1.3
Summary:  %summary
Conflicts:      python3-pluggy
Provides:       deprecated()

%description -n python3-pluggy1.3 %_description
...
%files -n python3-pluggy1.3 -f %{pyproject_files}
%doc README.rst
...
* Mon Jul 29 2024 Tomáš Hrnčiar <thrnciar@redhat.com> - 1.3.0-7
- Fork from the main pluggy package
