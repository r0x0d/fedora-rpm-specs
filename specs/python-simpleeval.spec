...
* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 1.0.7-2
- Rebuilt for Python 3.15

* Fri Mar 20 2026 Dan Horák <dan[at]danny.cz> - 1.0.7-1
- updated to 1.0.7 (rhbz#2446502)

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.0.3-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 1.0.3-6
...
* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 1.0.3-3
