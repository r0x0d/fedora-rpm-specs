...
BuildRequires:  pkgconfig(gstreamer-gl-wayland-1.0) >= 1.14
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-gl-wayland-1.0) >= 1.24
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-gl-wayland-1.0) >= 1.26
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(gstreamer-gl-wayland-1.0) >= 1.28
