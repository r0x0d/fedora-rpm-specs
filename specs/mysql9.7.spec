...
# run only "main" suite
%global last_tested_version 9.7.2
...
%global boost_bundled_version 1.87.0
...
Source0:          https://cdn.mysql.com/Downloads/MySQL-9.7/mysql-%{version}.tar.gz
Source3:          my.cnf.in
...
%{_libdir}/mysql/plugin/component_connection_control.so
%{_libdir}/mysql/plugin/component_group_replication_elect_prefers_most_updated.so
%{_libdir}/mysql/plugin/component_group_replication_flow_control_stats.so
%{_libdir}/mysql/plugin/component_group_replication_resource_manager.so
...
%{_libdir}/mysql/plugin/component_replication_applier_metrics.so
%{_libdir}/mysql/plugin/component_telemetry.so
%{_libdir}/mysql/plugin/component_test_component_deinit_no_deadlock.so
%{_libdir}/mysql/plugin/component_test_component_init_fail.so
%{_libdir}/mysql/plugin/component_test_component_init_then_register.so
%{_libdir}/mysql/plugin/component_test_mysql_file_service.so
%{_libdir}/mysql/plugin/component_test_session_var_service.so
%{_libdir}/mysql/plugin/component_test_telemetry_resource_provider.so
%{_libdir}/mysql/plugin/component_test_telemetry_secret_provider.so
%{_libdir}/mysql/plugin/component_test_udf_aggregate.so
...
%{_libdir}/mysql/plugin/telemetry_client.so
...
%{_libdir}/mysql/plugin/thread_pool.so
...
* Wed Jul 22 2026 Michal Schorm <mschorm@redhat.com> - 9.7.1-100
- Disable the 'distribution default' in MySQL 8.4 (package 'mysql8.4')
- Enable the 'distribution default' in MySQL 9.7 in this package

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 9.7.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 24 2026 Michal Schorm <mschorm@redhat.com> - 9.7.1-1
- Rebase to 9.7.1
