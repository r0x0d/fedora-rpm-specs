...
# * Downstream: ignore a doctest that would require a file not in the crate
Patch10:        0001-Downstream-ignore-a-doctest-that-would-require-a-fil.patch
...
%if %{with check}
%check
# * Skipped tests require files not included in published crates.
%{cargo_test -- -- --exact %{shrink:
    --skip tera::tests::can_load_from_glob
    --skip tera::tests::empty_list_on_invalid_glob
