...
%package     -n %{name}+tls-rustls-no-provider-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+tls-rustls-no-provider-devel %{_description}

This package contains library source intended for building other packages which
use the "tls-rustls-no-provider" feature of the "%{crate}" crate.

%files       -n %{name}+tls-rustls-no-provider-devel
%ghost %{crate_instdir}/Cargo.toml
