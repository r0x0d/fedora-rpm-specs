...
Version: 2.7.5
Release: %autorelease
Source0: https://github.com/libexpat/libexpat/releases/download/R_2_7_5/expat-%{version}.tar.gz
Source1: https://github.com/libexpat/libexpat/releases/download/R_2_7_5/expat-%{version}.tar.gz.asc
