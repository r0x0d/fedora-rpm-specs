...
%changelog
* Fri Jul 24 2026 Python Maint <python-maint@redhat.com> - 1:1.9.0-46
...
* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1:1.9.0-43
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Fri Jun 12 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 1:1.9.0-42
- Rebuilt for openssl 4.0

* Sun Jun 07 2026 František Zatloukal <fzatlouk@redhat.com> - 1:1.9.0-41
- Rebuilt for icu 78.3

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 1:1.9.0-40
- Rebuilt for Python 3.15

* Wed May 27 2026 František Zatloukal <fzatlouk@redhat.com> - 1:1.9.0-39
- Rebuilt for icu 78.3
