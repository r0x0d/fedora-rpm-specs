...
%if %{with lua}
%global hsluacli hslua-cli-1.4.4
...
%global lpeg lpeg-1.1.0.1
%global pandocluaengine pandoc-lua-engine-0.4.3
%global pandocluamarshal pandoc-lua-marshal-0.3.2.1
%if %{with server}
...
* Mon Jan 26 2026 Jens Petersen <petersen@redhat.com> - 3.8.3-40
- https://hackage.haskell.org/package/pandoc-cli-3.8.3/changelog

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.6.4-39
