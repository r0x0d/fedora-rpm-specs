...
BuildRequires:  (php-composer(sebastian/comparator) >= 5.0.2          with php-composer(sebastian/comparator) < 6)
...
Requires:       (php-composer(sebastian/comparator) >= 5.0.2          with php-composer(sebastian/comparator) < 6)
