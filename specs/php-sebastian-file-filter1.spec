# remirepo/fedora spec file for php-sebastian-file-filter1
#
...
%global ns_project   FileFilter

Name:           php-%{pk_vendor}-%{pk_project}%{major}
Version:        1.0.0
Release:        2%{?dist}
Summary:        Library for filtering files, version %{major}
...
* Fri Jun  5 2026 Remi Collet <remi@remirepo.net> - 1.0.0-1
- initial package
