...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.1.1-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 3.1.1-7
...
* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.1.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Wed Jun 04 2025 Python Maint <python-maint@redhat.com> - 3.1.1-2
- Rebuilt for Python 3.14

* Wed Mar 19 2025 Scott Talbert <swt@techie.net> - 3.1.1-1
- Update to new upstream release 3.1.1 (#2351643)
