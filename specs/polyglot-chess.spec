...
Name:           %{srcname}-chess
Version:        1.4
Release:        32.%{commitdate}git%(c=%{commit0}; echo ${c:0:7})%{?dist}
...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.4-32.20140902gitf46ee06
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.4-31.20140902gitf46ee06
