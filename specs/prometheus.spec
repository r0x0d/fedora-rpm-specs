...
Provides: bundled(nodejs-codemirror-commands) = 6.10.4
Provides: bundled(nodejs-codemirror-language) = 6.12.4
Provides: bundled(nodejs-codemirror-lint) = 6.9.7
Provides: bundled(nodejs-codemirror-search) = 6.7.1
Provides: bundled(nodejs-codemirror-state) = 6.7.1
Provides: bundled(nodejs-codemirror-view) = 6.43.6
Provides: bundled(nodejs-dayjs) = 1.11.21
Provides: bundled(nodejs-floating-ui-dom) = 1.8.0
...
Provides: bundled(nodejs-mantine-code-highlight) = 9.5.0
Provides: bundled(nodejs-mantine-core) = 9.5.0
Provides: bundled(nodejs-mantine-dates) = 9.5.0
Provides: bundled(nodejs-mantine-hooks) = 9.5.0
Provides: bundled(nodejs-mantine-notifications) = 9.5.0
...
Provides: bundled(nodejs-prometheus-io-codemirror-promql) = 0.315.0
Provides: bundled(nodejs-react) = 19.2.8
Provides: bundled(nodejs-react-dom) = 19.2.8
Provides: bundled(nodejs-react-infinite-scroll-component) = 6.1.1
Provides: bundled(nodejs-react-redux) = 9.3.0
Provides: bundled(nodejs-react-router-dom) = 7.18.1
Provides: bundled(nodejs-reduxjs-toolkit) = 2.12.0
Provides: bundled(nodejs-sanitize-html) = 2.17.6
Provides: bundled(nodejs-tabler-icons-react) = 3.45.0
Provides: bundled(nodejs-tanstack-react-query) = 5.101.4
Provides: bundled(nodejs-testing-library-jest-dom) = 7.0.0
...
Provides: bundled(nodejs-uiw-react-codemirror) = 4.25.11
Provides: bundled(nodejs-uplot) = 1.6.32
Provides: bundled(nodejs-use-query-params) = 2.2.2
Provides: npm(prometheus-io-mantine-ui) = 0.315.0
