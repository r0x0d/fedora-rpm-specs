...
Patch:          pari-2.13.0-xdgopen.patch
# Fix compiler warnings
# http://pari.math.u-bordeaux.fr/cgi-bin/bugreport.cgi?bug=1316
Patch:          pari-2.9.0-missing-field-init.patch
Patch:          pari-2.13.0-declaration-not-prototype.patch
Patch:          pari-2.13.0-clobbered.patch
Patch:          pari-2.13.0-signed-unsigned-comparison.patch
