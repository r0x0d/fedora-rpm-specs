...
%changelog
* Mon Jul 13 2026 Artur Frenszek-Iwicki <fedora@svgames.pl> - 5.5.0-1
- Update to v5.5.0
...
* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 5.2.1-9
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 5.2.1-8
