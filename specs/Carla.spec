...
* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1:2.5.10-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild
...
- Remove %%{name}-0001-fix-prototype.patch

* Wed Aug 07 2024 Martin Gansser <martinkg@fedoraproject.org> - 1:2.5.8-4
- Add %%{name}-0001-fix-prototype.patch for f41
