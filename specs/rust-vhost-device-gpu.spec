...
# allow mockall 0.11.4 and other dependencies not updated for now
Patch:          vhost-device-gpu-fix-metadata.diff
# Fix event API incompatibility with vmm-sys-util 0.14.0
Patch:          vhost-device-gpu-fix-event-api.patch
%endif
...
%package     -n %{name}+backend-gfxstream-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+backend-gfxstream-devel %{_description}

This package contains library source intended for building other packages which
use the "backend-gfxstream" feature of the "%{crate}" crate.

%files       -n %{name}+backend-gfxstream-devel
%ghost %{crate_instdir}/Cargo.toml

%package     -n %{name}+backend-virgl-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+backend-virgl-devel %{_description}

This package contains library source intended for building other packages which
use the "backend-virgl" feature of the "%{crate}" crate.

%files       -n %{name}+backend-virgl-devel
%ghost %{crate_instdir}/Cargo.toml
...
%if %{with check}
%check
%cargo_test -- -- --skip device::tests::test_display_output
%endif
