...
Name:           golang-github-google-trillian
Release:        %autorelease
...
# Remove dependnecy on github.com/apache/beam/sdks/v2
rm -rf experimental/batchmap tools
...
%if %{with check}
%check
# client/rpcflags, cmd/get_tree_public_key, storage/testdb, quota/redis/redistb quota/crdbqm: needs network
%gocheck -d client/rpcflags \
         -t cmd \
         -d server \
         -d storage/cloudspanner \
         -d storage/crdb \
         -d storage/testdb \
         -d util/election \
