...
%changelog
* Fri Jul 24 2026 Python Maint <python-maint@redhat.com> - 3.4.9.3-5
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 23 2026 Jitka Plesnikova <jplesnik@redhat.com> - 3.4.9.3-4
- Perl 5.44 rebuild

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 3.4.9.3-3
- Rebuilt for Python 3.15.0b4 ABI change
...
* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.4.8-17
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild
