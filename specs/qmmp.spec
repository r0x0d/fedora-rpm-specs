...
%changelog
* Fri Sep 18 2026 Karel Volný <kvolny@redhat.com> 2.4.2-2
- rebuild for libsidplayfp 3.x

* Thu Sep 17 2026 Karel Volný <kvolny@redhat.com> 2.4.2-1
- new version 2.4.2 (rhbz#2515504)
- see the upstream changelog at http://qmmp.ylsoftware.com/

* Thu Sep 03 2026 Dominik Mierzejewski <dominik@greysector.net> - 2.3.3-5
- Rebuilt for FFmpeg 9

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.3.3-4
...
* Mon Jun 08 2026 Karel Volný <kvolny@redhat.com> 2.3.3-1
- new version 2.3.3 (rhbz#2485513)
- see the upstream changelog at http://qmmp.ylsoftware.com/

* Thu Apr 16 2026 Karel Volný <kvolny@redhat.com> 2.3.2-1
- new version 2.3.2 (rhbz#2454885)
- see the upstream changelog at http://qmmp.ylsoftware.com/
...
* Thu Aug 14 2025 Karel Volný <kvolny@redhat.com> 2.2.7-1
- new version 2.2.7 (rhbz#2367635)
- see the upstream changelog at http://qmmp.ylsoftware.com/

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.2.5-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue May 27 2025 Jitka Plesnikova <jplesnik@redhat.com> - 2.2.5-2
- Rebuilt for flac 1.5.0

* Mon Apr 28 2025 Karel Volný <kvolny@redhat.com> 2.2.5-1
- new version 2.2.5 (rhbz#2362325)
- see the upstream changelog at http://qmmp.ylsoftware.com/

* Thu Apr 03 2025 Karel Volný <kvolny@redhat.com> 2.2.4-1
- new version 2.2.4 (rhbz#2355924)
- see the upstream changelog at http://qmmp.ylsoftware.com/
