...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 13.28-4
...
* Fri Jan 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 13.24-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Wed Jul 19 2023 Fedora Release Engineering <releng@fedoraproject.org> - 13.24-6
...
* Thu Jul 21 2022 Fedora Release Engineering <releng@fedoraproject.org> - 13.24-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Wed May 25 2022 Mattias Ellert <mattias.ellert@physics.uu.se> - 13.24-1
- New GCT release v6.2.20220524
- Drop patches included in the release

* Mon Mar 14 2022 Mattias Ellert <mattias.ellert@physics.uu.se> - 13.22-12
- Put back mutex fix

* Sun Mar 13 2022 Mattias Ellert <mattias.ellert@physics.uu.se> - 13.22-11
- Better fix for undefined variable in embedded close callback

* Sun Mar 13 2022 Mattias Ellert <mattias.ellert@physics.uu.se> - 13.22-10
- No mutex fix needed here

* Sun Mar 13 2022 Mattias Ellert <mattias.ellert@physics.uu.se> - 13.22-9
- Improved mutex fix

* Sat Mar 12 2022 Mattias Ellert <mattias.ellert@physics.uu.se> - 13.22-8
- Use sha256 hash when generating test certificates
- Fix some compiler warnings
- Fix unbalanced mutex lock/unlock

* Thu Jan 20 2022 Fedora Release Engineering <releng@fedoraproject.org> - 13.22-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Fri Dec 17 2021 Mattias Ellert <mattias.ellert@physics.uu.se> - 13.22-6
- Reenable optional test dependency fakeroot on EPEL 9 - now available

* Fri Dec 17 2021 Mattias Ellert <mattias.ellert@physics.uu.se> - 13.22-5
- Make XIO udt driver a weak dependency

* Thu Dec 16 2021 Mattias Ellert <mattias.ellert@physics.uu.se> - 13.22-4
- Drop optional test dependency fakeroot on EPEL 9 - not yet available

* Wed Nov 03 2021 Mattias Ellert <mattias.ellert@physics.uu.se> - 13.22-3
- Drop broken optional test dependency fakeroot on ppc64le in EPEL

* Tue Sep 14 2021 Sahana Prasad <sahana@redhat.com> - 13.22-2
- Rebuilt with OpenSSL 3.0.0

* Thu Aug 26 2021 Mattias Ellert <mattias.ellert@physics.uu.se> - 13.22-1
- Typo fixes

* Thu Jul 22 2021 Fedora Release Engineering <releng@fedoraproject.org> - 13.21-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Sat Mar 27 2021 Mattias Ellert <mattias.ellert@physics.uu.se> - 13.21-4
- Reenable optional test dependency fakeroot on Fedora 34+
  Fixes have been implemented in fakeroot-1.25.3-2

* Tue Mar 02 2021 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 13.21-3
- Rebuilt for updated systemd-rpm-macros
  See https://pagure.io/fesco/issue/2583.

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 13.21-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Sun Dec 13 2020 Mattias Ellert <mattias.ellert@physics.uu.se> - 13.21-1
- Restore log transfer functionality that was accidentally removed
- Specfile updates
- Replace /var/run with /run in systemd unit file
- Optional test dependency fakeroot:
  - Add on EPEL 8 - it is now available
  - Drop on Fedora 34+ - broken due to changes in glibc
