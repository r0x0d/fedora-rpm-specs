...
%changelog
* Fri Sep 11 2026 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 0.9.7-9
- Rebuilt for libxml-2.5.4

* Thu Sep 03 2026 Dominik Mierzejewski <dominik@greysector.net> - 0.9.7-8
- Rebuilt for FFmpeg 9

* Fri Jul 24 2026 Python Maint <python-maint@redhat.com> - 0.9.7-7
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 23 2026 Jitka Plesnikova <jplesnik@redhat.com> - 0.9.7-6
- Perl 5.44 rebuild

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 0.9.7-5
- Rebuilt for Python 3.15.0b4 ABI change

* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.9.7-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Sat Jun 13 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 0.9.7-3
- Rebuilt for openssl 4.0

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 0.9.7-2
