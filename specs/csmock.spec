...
%changelog
* Wed Jul 15 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.8.7-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 24 2026 Kamil Dudka <kdudka@redhat.com> - 3.8.7-1
- update to latest upstream

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 3.8.6-2
...
* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.8.3-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Oct 03 2025 Kamil Dudka <kdudka@redhat.com> - 3.8.3-1
- update to latest upstream
...
* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.8.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Thu Jul 03 2025 Kamil Dudka <kdudka@redhat.com> - 3.8.2-1
- update to latest upstream

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 3.8.1-2
- Rebuilt for Python 3.14

* Tue Apr 15 2025 Kamil Dudka <kdudka@redhat.com> - 3.8.1-1
- update to latest upstream
