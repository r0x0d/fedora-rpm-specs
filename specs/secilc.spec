...
Source0:        https://github.com/SELinuxProject/selinux/releases/download/%{version}-rc2/secilc-%{version}-rc2.tar.gz
Source1:        https://github.com/SELinuxProject/selinux/releases/download/%{version}-rc2/secilc-%{version}-rc2.tar.gz.asc
Source2:        https://github.com/bachradsusi.gpg
# fedora-selinux/selinux: git format-patch -N 3.9-rc2 -- secilc
