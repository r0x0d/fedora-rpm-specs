...
%files
%license COPYING
%doc README.md README_BAD.md TFMX.md TFMX_HIP_FC.md NEWS.md
%{_libdir}/%{name}.so.*
...
* Mon Jun 15 2026 Michael Schwendt <mschwendt@fedoraproject.org> - 1.0.13-1
- update to 1.0.13

* Sun Jun 14 2026 Michael Schwendt <mschwendt@fedoraproject.org> - 1.0.12-1
- update to 1.0.12

* Thu Jun 11 2026 Michael Schwendt <mschwendt@fedoraproject.org> - 1.0.11-1
- update to 1.0.11

* Wed Jun 10 2026 Michael Schwendt <mschwendt@fedoraproject.org> - 1.0.10-1
- update to 1.0.10

* Sun May 24 2026 Michael Schwendt <mschwendt@fedoraproject.org> - 1.0.9-1
- update to 1.0.9 regression fix

* Fri May 22 2026 Michael Schwendt <mschwendt@fedoraproject.org> - 1.0.8-1
- update to 1.0.8

* Sat May 02 2026 Michael Schwendt <mschwendt@fedoraproject.org> - 1.0.7-1
- update to 1.0.7

* Sat May 02 2026 Michael Schwendt <mschwendt@fedoraproject.org> - 1.0.6-1
- update to 1.0.6

* Sun Apr 26 2026 Michael Schwendt <mschwendt@fedoraproject.org> - 1.0.5-1
- update to 1.0.5

* Tue Apr 14 2026 Michael Schwendt <mschwendt@fedoraproject.org> - 1.0.4-1
- update to 1.0.4

* Tue Apr 07 2026 Michael Schwendt <mschwendt@fedoraproject.org> - 1.0.3-1
- update to 1.0.3
