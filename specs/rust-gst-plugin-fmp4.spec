...
# * missing dev-dependencies: dash-mpd, m3u8-rs
%bcond check 0
...
License:        MPL-2.0
URL:            https://crates.io/crates/gst-plugin-fmp4
...
%package     -n gstreamer1-plugin-fmp4
Summary:        %{summary}
# Apache-2.0 OR MIT
# MIT
# MIT OR Apache-2.0
...
%description -n gstreamer1-plugin-fmp4 %{_description}

%files       -n gstreamer1-plugin-fmp4
%license LICENSE
%license LICENSE.dependencies
%{_libdir}/gstreamer-1.0/libgstfmp4.so
...
rm -v %{buildroot}/%{_libdir}/gstreamer-1.0/libgstfmp4.a
# remove unnecessary pkgconfig file
rm -v %{buildroot}/%{_libdir}/pkgconfig/gstfmp4.pc
