...
Source0:    https://tarballs.openstack.org/%{sname}/oslo_config-%{upstream_version}.tar.gz
# Required for tarball sources verification
%if 0%{?sources_gpg} == 1
Source101:        https://tarballs.openstack.org/%{sname}/oslo_config-%{upstream_version}.tar.gz.asc
...
%endif
%autosetup -n oslo_config-%{upstream_version} -S git
