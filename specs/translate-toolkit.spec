...
%changelog
* Tue Sep 22 2026 Manish Tiwari <matiwari@redhat.com> - 3.20.0-1
- update to 3.20.0
- https://github.com/translate/translate/releases#release-3.20.0

* Mon Aug 17 2026 Manish Tiwari <matiwari@redhat.com> - 3.19.17-1
- update to 3.19.17
- https://github.com/translate/translate/releases/tag/3.19.17

* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.19.13-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Mon Jun 29 2026 Manish Tiwari <matiwari@redhat.com> - 3.19.13-1
- update to 3.19.13

* Tue Jun 09 2026 Python Maint <python-maint@redhat.com> - 3.19.5-2
- Rebuilt for Python 3.15

* Thu Apr 16 2026 Sudip Shil <sshil@redhat.com> - 3.19.5-1
- update to 3.19.5 (rhbz#2456894)

* Sun Mar 15 2026 Sudip Shil <sshil@redhat.com> - 2429738-1
- update to 3.19.3 (rhbz#2429738)

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.18.0-2
...
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 3.16.0-2
- Rebuilt for Python 3.14.0rc3 bytecode

* Mon Sep 08 2025 Sudip Shil <sshil@redhat.com> - 3.16.0-1
- update to 3.16.0 (rhbz#2376129)

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 3.15.6-3
...
* Wed Jun 11 2025 Sudip Shil <sshil@redhat.com> - 3.15.5-1
- update to 3.15.5 (rhbz#2372967)

* Wed Jun 11 2025 Sudip Shil <sshil@redhat.com> - 3.15.3-2
- update to 3.15.3 (rhbz#2371515)

* Wed Jun 04 2025 Python Maint <python-maint@redhat.com> - 3.15.2-2
- Rebuilt for Python 3.14

* Sun May 11 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 3.15.2-3
- Remove spurious BuildRequires on python3-uv
- pr-13-no-uv-dep
...
* Sun Jan 19 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.14.5-2
