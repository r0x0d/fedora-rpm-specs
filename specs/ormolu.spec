...
%global subpkgs %{choice} %{markdownunlit} %{thenv}
...
Source2:        https://hackage.haskell.org/package/%{markdownunlit}/%{markdownunlit}.tar.gz
...
%ghc_lib_subpackage -l BSD-3-Clause %{choice}
