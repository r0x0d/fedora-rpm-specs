...
Version:        0.1.0
Release:        0.22.%{date0}git%{scommit0}%{?dist}
...
%changelog
* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.1.0-0.22.20149631git3ff37a2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Fri Jun 06 2025 Python Maint <python-maint@redhat.com> - 0.1.0-0.21.20149631git3ff37a2
