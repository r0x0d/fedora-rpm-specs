...
%changelog
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 0.5.0~20231031git5aea0fd-6
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 0.5.0~20231031git5aea0fd-5
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.5.0~20231031git5aea0fd-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Wed Jun 04 2025 Python Maint <python-maint@redhat.com> - 0.5.0~20231031git5aea0fd-3
