...
%global git_commit  f45ef0e422244630972c092984da7cfeee69c52e
%global git_commit_short  %(c="%{git_commit}"; echo ${c:0:7})

# Version number taken from 'debian/changelog' file
Version: 0.8.5^%{git_date}.git%{git_commit_short}
Release: 1%{?dist}
...
%changelog
* Mon Sep 21 2026 Artur Frenszek-Iwicki <fedora@svgames.pl> - 0.8.5^20260910.gitf45ef0e-1
- Update to v0.8.5
...
* Tue May 19 2026 Artur Frenszek-Iwicki <fedora@svgames.pl> - 0.7.0^20260402.d61d029-1
- Update to v0.7.0

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.6.8^20251225.5af1f34-2
...
* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.6.3.3^20250322.3e522d9-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jun 16 2025 Artur Frenszek-Iwicki <fedora@svgames.pl> - 0.6.3.3^20250322.3e522d9-1
- Update to latest git snapshot (2025-03-22)
