...
See python3-pyxdf-examples for the command-line examples (pyxdf.examples).
...
# manual dependency on it to this subpackage, since pyxdf.examples.playback_lsl
# uses it.
...
%exclude %{python3_sitelib}/pyxdf/examples/


%files -n python3-pyxdf-examples
%{python3_sitelib}/pyxdf/examples/
