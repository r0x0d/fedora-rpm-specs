...
# fix(5.14.x): Use '==' instead of 'is' in template if condition because of old Jinja2 version on EL8
...
* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 5.14.1-7
- Rebuilt for Python 3.14

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 5.14.1-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Fri Jul 26 2024 Miroslav Suchý <msuchy@redhat.com> - 5.14.1-5
- convert license to SPDX

* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 5.14.1-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Fri Jun 07 2024 Python Maint <python-maint@redhat.com> - 5.14.1-3
- Rebuilt for Python 3.13

* Mon May 27 2024 Dominik Wombacher <dominik@wombacher.cc> - 5.14.1-2
- Backport patches to fix issues on EL8 (https://pagure.io/pagure/pull-request/5486)
- fix(5.14.x): Use '==' instead of 'is' in template if condition because of old Jinja2 version on EL8
- fix(oidc): Edge case, avoid 'KeyError' after pagure update if a cached session is used

* Fri May 24 2024 Dominik Wombacher <dominik@wombacher.cc> - 5.14.1-1
- Update to new release 5.14.1
- Includes all previously backported patches
- Fixes rhbz#2277121, rhbz#2278745, rhbz#2279411, rhbz#2280725, rhbz#2280723, rhbz#2280728, rhbz#2280726

* Tue Apr 23 2024 Maja Massarini <mmassari@redhat.com> - 5.13.3-14
- Backport patch: owner_of_a_pr_can_update_is_own_pr.patch from upstream commit: a3cd8f60bc7f7c8f29f1ce0f0737c2778bb839d2
- Backport patch: allow_author_to_update_pr_but_not_to_change_assignee.patch from upstream commit: c8ea20215862e8ea8611fec66e1a386aff91c65c
- Backport patch: fix_pagure_lib_git_get_changed_files.patch from upstream commit: 1b36cb8e32bab2fac9d5a51a374522069b537342

* Tue Apr 02 2024 Nikola Forró <nforro@redhat.com> - 5.13.3-13
- Backport patch: push_notification_pr_id.patch from upstream commit: 8ed510d99c9fbe3736c96b751d567891cbad343a
- Backport patch: user_token_pr_close_acl.patch from upstream commit: 661557f3ecab5630e083ae498a54398ca3b5f007
