...
# * remove non-Linux features and dependencies
# * exclude files that are only useful for upstream development:
#   https://github.com/rust-random/rand/pull/635
Patch:          rand-fix-metadata.diff
# * drop "deny(warnings)" lint from doctests to make them compile
