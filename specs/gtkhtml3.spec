...
Source: http://download.gnome.org/sources/gtkhtml/4.10/gtkhtml-%{version}.tar.xz
...
* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-21
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Wed Jan 24 2024 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-20
...
* Thu Jan 19 2023 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-17
- Rebuilt for https://fedoraproject.org/wiki/Fedora_38_Mass_Rebuild

* Thu Jul 21 2022 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-16
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Thu Jan 20 2022 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-15
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Thu Jul 22 2021 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-14
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Tue Jan 26 2021 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-13
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Tue Jul 28 2020 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-12
- Rebuilt for https://fedoraproject.org/wiki/Fedora_33_Mass_Rebuild

* Wed Jan 29 2020 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-11
- Rebuilt for https://fedoraproject.org/wiki/Fedora_32_Mass_Rebuild

* Thu Jul 25 2019 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_31_Mass_Rebuild

* Fri Feb 01 2019 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-9
- Rebuilt for https://fedoraproject.org/wiki/Fedora_30_Mass_Rebuild

* Fri Jul 13 2018 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_29_Mass_Rebuild

* Fri Feb 09 2018 Igor Gnatenko <ignatenkobrain@fedoraproject.org> - 4.10.0-7
- Escape macros in %%changelog

* Wed Feb 07 2018 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_28_Mass_Rebuild

* Wed Aug 02 2017 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_27_Binutils_Mass_Rebuild

* Wed Jul 26 2017 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_27_Mass_Rebuild

* Fri Feb 10 2017 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_26_Mass_Rebuild

* Wed Feb 03 2016 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_24_Mass_Rebuild

* Mon Sep 21 2015 Milan Crha <mcrha@redhat.com> - 4.10.0-1
- Update to 4.10.0

* Mon Sep 14 2015 Milan Crha <mcrha@redhat.com> - 4.9.92-1
- Update to 4.9.92
- Move gtkhtml-editor-test into the devel subpackage

* Wed Jun 17 2015 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 4.8.5-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_23_Mass_Rebuild

* Mon Oct 13 2014 Milan Crha <mcrha@redhat.com> - 4.8.5-1
- Update to 4.8.5

* Sat Aug 16 2014 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 4.8.4-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_21_22_Mass_Rebuild

* Mon Aug 11 2014 Milan Crha <mcrha@redhat.com> - 4.8.4-1
- Update to 4.8.4
- Remove patch for RH bug #1120291 (fixed upstream)

* Thu Jul 17 2014 Milan Crha <mcrha@redhat.com> - 4.8.3-2
- Add patch for RH bug #1120291 (missing chain-up-s for constructed() method)

* Mon Jul 14 2014 Milan Crha <mcrha@redhat.com> - 4.8.3-1
- Update to 4.8.3

* Mon Jun 09 2014 Milan Crha <mcrha@redhat.com> - 4.8.2-1
- Update to 4.8.2

* Sat Jun 07 2014 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 4.8.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_21_Mass_Rebuild

* Fri May 02 2014 Milan Crha <mcrha@redhat.com> - 4.8.1-1
- Update to 4.8.1

* Mon Mar 24 2014 Milan Crha <mcrha@redhat.com> - 4.8.0-1
- Update to 4.8.0

* Wed Mar 12 2014 Milan Crha <mcrha@redhat.com> - 4.6.6-3
- Use pkgconfig() notations in BuildRequires where applicable

* Sat Aug 03 2013 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 4.6.6-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_20_Mass_Rebuild

* Tue Jul 23 2013 Milan Crha <mcrha@redhat.com> - 4.6.6-1
- Update to 4.6.6

* Fri Jun 28 2013 Kalev Lember <kalevlember@gmail.com> - 4.6.5-2
- Adapt for gnome-icon-theme packaging changes

* Sun May 12 2013 Matthew Barnes <mbarnes@redhat.com> - 4.6.5-1
- Update to 4.6.5

* Mon Feb 18 2013 Milan Crha <mcrha@redhat.com> - 4.6.4-1
- Update to 4.6.4

* Mon Feb 04 2013 Milan Crha <mcrha@redhat.com> - 4.6.3-1
- Update to 4.6.3

* Mon Jan 14 2013 Milan Crha <mcrha@redhat.com> - 4.6.2-1
- Update to 4.6.2
