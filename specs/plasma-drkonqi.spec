...
%changelog
* Sun Jun 01 2025 Pavel Solovev <daron439@gmail.com> - 6.3.91-3
...
* Fri Jul 26 2024 Timothée Ravier <tim@siosm.fr> - 6.1.3-4
- The debuginfo-install command is now part of dnf5, so require it only up to
  Fedora 40
...
* Fri Apr 05 2024 Dipta Biswas <dabiswas112@gmail.com> - 6.0.3-3
- Add support for installing debug symbols automagically with gdb >= 12

* Fri Apr 05 2024 Adam Williamson <awilliam@redhat.com> - 6.0.3-2
- Backport MR #232 to fix logout soon after login (#2272712)
...
* Thu Nov 30 2023 Alessandro Astone <ales.astone@gmail.com> - 5.27.80-3
- Rebuild (qt6)
...
* Tue May 31 2022 Jan Grulich <jgrulich@redhat.com> - 5.24.90-2
- BR: systemd-devel
...
* Mon Nov 29 2021 Timothée Ravier <tim@siosm.fr> - 5.23.3-2
- Only require debuginfo installation support if dnf is installed. This avoids
  pulling dnf on Kinoite.
