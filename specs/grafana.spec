...
Patch4:           0004-remove-unused-frontend-crypto.patch
Patch5:           0005-skip-marketplace-plugin-install-test.patch
Patch6:           0006-redact-weak-ciphers.patch
...
Provides: bundled(golang(buf.build/gen/go/parca-dev/parca/connectrpc/go)) = 1.18.1-20250703125925.3f0fcf4bff96.1
Provides: bundled(golang(buf.build/gen/go/parca-dev/parca/protocolbuffers/go)) = 1.36.2-20250703125925.3f0fcf4bff96.1
Provides: bundled(golang(cloud.google.com/go/kms)) = 1.22.0
Provides: bundled(golang(cloud.google.com/go/storage)) = 1.55.0
Provides: bundled(golang(connectrpc.com/connect)) = 1.19.1
Provides: bundled(golang(cuelang.org/go)) = 0.11.1
Provides: bundled(golang(dario.cat/mergo)) = 1.0.2
Provides: bundled(golang(filippo.io/age)) = 1.2.1
Provides: bundled(golang(github.com/1NCE-GmbH/grpc-go-pool)) = 0.0.0-20231117122434.2a5bb974daa2
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go)) = 68.0.0+incompatible
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/azcore)) = 1.19.1
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/azidentity)) = 1.12.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/keyvault/azkeys)) = 0.10.0
...
Provides: bundled(golang(github.com/Azure/go-autorest/autorest/adal)) = 0.9.24
Provides: bundled(golang(github.com/Bose/minisentinel)) = 0.0.0-20200130220412.917c5a9223bb
Provides: bundled(golang(github.com/BurntSushi/toml)) = 1.5.0
Provides: bundled(golang(github.com/DATA-DOG/go-sqlmock)) = 1.5.2
Provides: bundled(golang(github.com/Masterminds/semver)) = 1.5.0
Provides: bundled(golang(github.com/Masterminds/semver/v3)) = 3.4.0
...
Provides: bundled(golang(github.com/alicebob/miniredis/v2)) = 2.34.0
Provides: bundled(golang(github.com/andybalholm/brotli)) = 1.2.0
Provides: bundled(golang(github.com/apache/arrow-go/v18)) = 18.5.1
...
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/cloudwatch)) = 1.45.3
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs)) = 1.51.0
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/ec2)) = 1.225.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/oam)) = 1.18.3
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/resourcegroupstaggingapi)) = 1.26.6
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/secretsmanager)) = 1.40.1
...
Provides: bundled(golang(github.com/blevesearch/bleve/v2)) = 2.5.7
Provides: bundled(golang(github.com/blevesearch/bleve_index_api)) = 1.3.0
Provides: bundled(golang(github.com/bradfitz/gomemcache)) = 0.0.0-20250403215159.8d39553ac7cf
Provides: bundled(golang(github.com/bwmarrin/snowflake)) = 0.3.0
Provides: bundled(golang(github.com/centrifugal/centrifuge)) = 0.38.0
Provides: bundled(golang(github.com/crewjam/saml)) = 0.4.14
Provides: bundled(golang(github.com/dgraph-io/badger/v4)) = 4.7.0
Provides: bundled(golang(github.com/dlmiddlecote/sqlstats)) = 1.0.2
Provides: bundled(golang(github.com/docker/go-connections)) = 0.6.0
Provides: bundled(golang(github.com/dolthub/go-mysql-server)) = 0.19.1-0.20250410182021.5632d67cd46e
Provides: bundled(golang(github.com/dolthub/vitess)) = 0.0.0-20260225173707.20566e4abe9e
...
Provides: bundled(golang(github.com/fullstorydev/grpchan)) = 1.1.1
...
Provides: bundled(golang(github.com/go-logfmt/logfmt)) = 0.6.1
Provides: bundled(golang(github.com/go-openapi/loads)) = 0.23.2
Provides: bundled(golang(github.com/go-openapi/runtime)) = 0.28.0
Provides: bundled(golang(github.com/go-openapi/strfmt)) = 0.25.0
Provides: bundled(golang(github.com/go-redis/redis/v8)) = 8.11.5
Provides: bundled(golang(github.com/go-sourcemap/sourcemap)) = 2.1.4+incompatible
...
Provides: bundled(golang(github.com/golang/mock)) = 1.7.0-rc.1
Provides: bundled(golang(github.com/golang/protobuf)) = 1.5.4
Provides: bundled(golang(github.com/golang/snappy)) = 1.0.0
...
Provides: bundled(golang(github.com/google/wire)) = 0.7.0
Provides: bundled(golang(github.com/googleapis/gax-go/v2)) = 2.15.0
Provides: bundled(golang(github.com/gorilla/mux)) = 1.8.1
Provides: bundled(golang(github.com/gorilla/websocket)) = 1.5.4-0.20250319132907.e064f32e3674
Provides: bundled(golang(github.com/grafana/alerting)) = 0.0.0-20260206150146.b5f69c55f91a
Provides: bundled(golang(github.com/grafana/authlib)) = 0.0.0-20260203153107.16a114a99f67
Provides: bundled(golang(github.com/grafana/authlib/types)) = 0.0.0-20260203131350.b83e80394acc
Provides: bundled(golang(github.com/grafana/dataplane/examples)) = 0.0.1
Provides: bundled(golang(github.com/grafana/dataplane/sdata)) = 0.0.9
Provides: bundled(golang(github.com/grafana/dskit)) = 0.0.0-20260108123158.1a1acfb6ef2e
Provides: bundled(golang(github.com/grafana/e2e)) = 0.1.1
Provides: bundled(golang(github.com/grafana/gofpdf)) = 0.0.0-20250307124105.3b9c5d35577f
Provides: bundled(golang(github.com/grafana/gomemcache)) = 0.0.0-20251127154401.74f93547077b
Provides: bundled(golang(github.com/grafana/grafana-api-golang-client)) = 0.27.0
Provides: bundled(golang(github.com/grafana/grafana-app-sdk)) = 0.50.2
Provides: bundled(golang(github.com/grafana/grafana-app-sdk/logging)) = 0.50.2
Provides: bundled(golang(github.com/grafana/grafana-aws-sdk)) = 1.4.3
Provides: bundled(golang(github.com/grafana/grafana-azure-sdk-go/v2)) = 2.3.1
Provides: bundled(golang(github.com/grafana/grafana-cloud-migration-snapshot)) = 1.9.0
Provides: bundled(golang(github.com/grafana/grafana-google-sdk-go)) = 0.4.2
Provides: bundled(golang(github.com/grafana/grafana-openapi-client-go)) = 0.0.0-20231213163343.bd475d63fb79
Provides: bundled(golang(github.com/grafana/grafana-plugin-sdk-go)) = 0.287.0
Provides: bundled(golang(github.com/grafana/loki/pkg/push)) = 0.0.0-20250823105456.332df2b20000
Provides: bundled(golang(github.com/grafana/loki/v3)) = 3.2.1
Provides: bundled(golang(github.com/grafana/nanogit)) = 0.3.0
Provides: bundled(golang(github.com/grafana/otel-profiling-go)) = 0.5.1
Provides: bundled(golang(github.com/grafana/pyroscope-go/godeltaprof)) = 0.1.9
Provides: bundled(golang(github.com/grafana/pyroscope/api)) = 1.2.1-0.20251118081820.ace37f973a0f
Provides: bundled(golang(github.com/grafana/tempo)) = 1.5.1-0.20250529124718.87c2dc380cec
Provides: bundled(golang(github.com/grpc-ecosystem/go-grpc-middleware)) = 1.4.0
Provides: bundled(golang(github.com/grpc-ecosystem/go-grpc-middleware/providers/prometheus)) = 1.1.0
Provides: bundled(golang(github.com/grpc-ecosystem/go-grpc-middleware/v2)) = 2.3.3
Provides: bundled(golang(github.com/grpc-ecosystem/grpc-gateway/v2)) = 2.27.7
Provides: bundled(golang(github.com/hashicorp/go-hclog)) = 1.6.3
Provides: bundled(golang(github.com/hashicorp/go-multierror)) = 1.1.1
Provides: bundled(golang(github.com/hashicorp/go-plugin)) = 1.7.0
...
Provides: bundled(golang(github.com/hashicorp/hcl/v2)) = 2.24.0
Provides: bundled(golang(github.com/huandu/xstrings)) = 1.5.0
Provides: bundled(golang(github.com/influxdata/influxdb-client-go/v2)) = 2.13.0
Provides: bundled(golang(github.com/influxdata/influxql)) = 1.4.0
Provides: bundled(golang(github.com/influxdata/line-protocol)) = 0.0.0-20210922203350.b1ad95c89adf
Provides: bundled(golang(github.com/jackc/pgx/v5)) = 5.8.0
Provides: bundled(golang(github.com/jmespath-community/go-jmespath)) = 1.1.1
Provides: bundled(golang(github.com/jmespath/go-jmespath)) = 0.4.0
Provides: bundled(golang(github.com/jmoiron/sqlx)) = 1.4.0
...
Provides: bundled(golang(github.com/madflojo/testcerts)) = 1.4.0
Provides: bundled(golang(github.com/mattn/go-isatty)) = 0.0.20
Provides: bundled(golang(github.com/mattn/go-sqlite3)) = 1.14.32
Provides: bundled(golang(github.com/matttproud/golang_protobuf_extensions)) = 1.0.4
Provides: bundled(golang(github.com/microsoft/go-mssqldb)) = 1.9.2
Provides: bundled(golang(github.com/migueleliasweb/go-github-mock)) = 1.5.0
Provides: bundled(golang(github.com/mitchellh/mapstructure)) = 1.5.1-0.20231216201459.8508981c8b6c
Provides: bundled(golang(github.com/mocktools/go-smtp-mock/v2)) = 2.5.1
Provides: bundled(golang(github.com/modern-go/reflect2)) = 1.0.3-0.20250322232337.35a7c28c31ee
...
Provides: bundled(golang(github.com/open-feature/go-sdk)) = 1.17.0
Provides: bundled(golang(github.com/open-feature/go-sdk-contrib/providers/go-feature-flag)) = 0.2.6
Provides: bundled(golang(github.com/open-feature/go-sdk-contrib/providers/ofrep)) = 0.1.7
Provides: bundled(golang(github.com/openfga/api/proto)) = 0.0.0-20260122164422.25e22cb1875b
Provides: bundled(golang(github.com/openfga/language/pkg/go)) = 0.2.0-beta.2.0.20251027165255.0f8f255e5f6c
Provides: bundled(golang(github.com/openfga/openfga)) = 1.11.3
Provides: bundled(golang(github.com/opentracing-contrib/go-grpc)) = 0.1.2
Provides: bundled(golang(github.com/opentracing/opentracing-go)) = 1.2.0
Provides: bundled(golang(github.com/openzipkin/zipkin-go)) = 0.4.3
Provides: bundled(golang(github.com/patrickmn/go-cache)) = 2.1.0+incompatible
Provides: bundled(golang(github.com/phpdave11/gofpdi)) = 1.0.14
Provides: bundled(golang(github.com/pressly/goose/v3)) = 3.26.0
Provides: bundled(golang(github.com/prometheus/alertmanager)) = 0.28.2
...
Provides: bundled(golang(github.com/prometheus/prometheus)) = 0.303.1
Provides: bundled(golang(github.com/prometheus/sigv4)) = 0.1.2
Provides: bundled(golang(github.com/puzpuzpuz/xsync/v4)) = 4.2.0
Provides: bundled(golang(github.com/redis/go-redis/v9)) = 9.14.0
Provides: bundled(golang(github.com/robfig/cron/v3)) = 3.0.1
Provides: bundled(golang(github.com/rs/cors)) = 1.11.1
Provides: bundled(golang(github.com/russellhaering/goxmldsig)) = 1.6.0
...
Provides: bundled(golang(github.com/spyzhov/ajson)) = 0.9.6
Provides: bundled(golang(github.com/stretchr/testify)) = 1.11.1
Provides: bundled(golang(github.com/testcontainers/testcontainers-go)) = 0.36.0
Provides: bundled(golang(github.com/thomaspoignant/go-feature-flag)) = 1.42.0
Provides: bundled(golang(github.com/tjhop/slog-gokit)) = 0.1.5
Provides: bundled(golang(github.com/ua-parser/uap-go)) = 0.0.0-20250213224047.9c035f085b90
Provides: bundled(golang(github.com/urfave/cli)) = 1.22.17
Provides: bundled(golang(github.com/urfave/cli/v2)) = 2.27.7
Provides: bundled(golang(github.com/urfave/cli/v3)) = 3.5.0
Provides: bundled(golang(github.com/wk8/go-ordered-map)) = 1.0.0
Provides: bundled(golang(github.com/xlab/treeprint)) = 1.2.0
Provides: bundled(golang(github.com/youmark/pkcs8)) = 0.0.0-20240726163527.a2c0da244d78
Provides: bundled(golang(github.com/yudai/gojsondiff)) = 1.0.0
Provides: bundled(golang(go.etcd.io/bbolt)) = 1.4.3
Provides: bundled(golang(go.opentelemetry.io/collector/pdata)) = 1.44.0
Provides: bundled(golang(go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc)) = 0.64.0
Provides: bundled(golang(go.opentelemetry.io/contrib/instrumentation/net/http/httptrace/otelhttptrace)) = 0.64.0
Provides: bundled(golang(go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp)) = 0.64.0
Provides: bundled(golang(go.opentelemetry.io/contrib/propagators/jaeger)) = 1.39.0
Provides: bundled(golang(go.opentelemetry.io/contrib/samplers/jaegerremote)) = 0.33.0
Provides: bundled(golang(go.opentelemetry.io/otel)) = 1.39.0
Provides: bundled(golang(go.opentelemetry.io/otel/exporters/jaeger)) = 1.17.0
Provides: bundled(golang(go.opentelemetry.io/otel/exporters/otlp/otlplog/otlploggrpc)) = 0.15.0
Provides: bundled(golang(go.opentelemetry.io/otel/exporters/otlp/otlptrace)) = 1.39.0
Provides: bundled(golang(go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc)) = 1.39.0
Provides: bundled(golang(go.opentelemetry.io/otel/log)) = 0.15.0
Provides: bundled(golang(go.opentelemetry.io/otel/sdk)) = 1.39.0
Provides: bundled(golang(go.opentelemetry.io/otel/sdk/log)) = 0.15.0
...
Provides: bundled(golang(go.uber.org/mock)) = 0.6.0
...
Provides: bundled(golang(gocloud.dev)) = 0.43.0
Provides: bundled(golang(gocloud.dev/secrets/hashivault)) = 0.43.0
Provides: bundled(golang(golang.org/x/crypto)) = 0.47.0
Provides: bundled(golang(golang.org/x/exp)) = 0.0.0-20260112195511.716be5621a96
...
Provides: bundled(golang(gonum.org/v1/gonum)) = 0.17.0
Provides: bundled(golang(google.golang.org/api)) = 0.242.0
...
Provides: bundled(golang(k8s.io/api)) = 0.35.0
Provides: bundled(golang(k8s.io/apiextensions-apiserver)) = 0.35.0
Provides: bundled(golang(k8s.io/apimachinery)) = 0.35.0
Provides: bundled(golang(k8s.io/apiserver)) = 0.35.0
Provides: bundled(golang(k8s.io/client-go)) = 0.35.0
Provides: bundled(golang(k8s.io/component-base)) = 0.35.0
Provides: bundled(golang(k8s.io/klog/v2)) = 2.130.1
Provides: bundled(golang(k8s.io/kube-aggregator)) = 0.35.0
Provides: bundled(golang(k8s.io/kube-openapi)) = 0.0.0-20260127142750.a19766b6e2d4
Provides: bundled(golang(k8s.io/utils)) = 0.0.0-20251002143259.bc988d571ff4
Provides: bundled(golang(modernc.org/sqlite)) = 1.44.3
Provides: bundled(golang(pgregory.net/rapid)) = 1.2.0
Provides: bundled(golang(sigs.k8s.io/randfill)) = 1.0.0
Provides: bundled(golang(sigs.k8s.io/structured-merge-diff/v6)) = 6.3.1
Provides: bundled(golang(xorm.io/builder)) = 0.3.13
Provides: bundled(golang(github.com/grafana/grafana/apps/example)) = 0.0.0-20260119093047.426e55f358f5
Provides: bundled(golang(github.com/grafana/grafana/apps/quotas)) = 0.0.0-20251209183543.1013d74f13f2
Provides: bundled(golang(github.com/grafana/grafana/apps/scope)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/pkg/aggregator)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/pkg/apimachinery)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/pkg/apiserver)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/pkg/plugins)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/pkg/promlib)) = 0.0.8
Provides: bundled(golang(github.com/grafana/grafana/pkg/semconv)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/pkg/storage/unified/resource/kv)) = 0.0.0
Provides: bundled(golang(github.com/cenkalti/backoff/v4)) = 4.3.0
Provides: bundled(golang(github.com/grafana/grafana/apps/advisor)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/alerting/alertenrichment)) = 0.0.0-00010101000000.000000000000
Provides: bundled(golang(github.com/grafana/grafana/apps/alerting/historian)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/alerting/notifications)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/alerting/rules)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/annotation)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/collections)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/correlations)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/dashboard)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/dashvalidator)) = 0.0.0-20260127080522.461c3f3f9fb6
Provides: bundled(golang(github.com/grafana/grafana/apps/folder)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/iam)) = 0.0.0-00010101000000.000000000000
Provides: bundled(golang(github.com/grafana/grafana/apps/live)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/logsdrilldown)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/playlist)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/plugins)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/preferences)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/provisioning)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/secret)) = 0.0.0
Provides: bundled(golang(github.com/grafana/grafana/apps/shorturl)) = 0.0.0
Provides: bundled(golang(github.com/RoaringBitmap/real-roaring-datasets)) = 0.0.0-20190726190000.eb7c87156f76
Provides: bundled(golang(github.com/grafana/gomemcache)) = 0.0.0-20250828162811.a96f6acee2fe
Provides: bundled(golang(github.com/mattn/go-sqlite3)) = 2.0.3+incompatible
Provides: bundled(golang(github.com/prometheus/prometheus)) = 1.8.2-0.20221021121301.51a44e6657c3
Provides: bundled(golang(github.com/testcontainers/testcontainers-go)) = 0.38.0
Provides: bundled(golang(k8s.io/client-go)) = 12.0.0+incompatible
...
Provides: bundled(npm(@grafana/faro-core)) = 1.19.0
Provides: bundled(npm(@grafana/faro-instrumentation-replay)) = 2.2.3
Provides: bundled(npm(@grafana/faro-web-sdk)) = 1.19.0
Provides: bundled(npm(@grafana/faro-web-tracing)) = 2.2.3
...
Provides: bundled(npm(@grafana/scenes-react)) = 6.52.13
...
Provides: bundled(npm(@types/ol-ext)) = 3.3.0
...
Provides: bundled(npm(kbar)) = 0.1.0b48
Provides: bundled(npm(lerna)) = 9.0.3
...
Provides: bundled(npm(node-forge)) = 1.3.3
...
Provides: bundled(npm(rollup)) = 4.46.1
...
Provides: bundled(npm(webpack)) = 5.101.0
...
Provides: bundled(npm(webpack-subresource-integrity)) = 5.2.0rc1
...
%ghost %attr(0755, %{GRAFANA_USER}, %{GRAFANA_GROUP}) %dir /run/grafana
...
%doc AGENTS.md CHANGELOG.md CODE_OF_CONDUCT.md CONTRIBUTING.md GOVERNANCE.md HALL_OF_FAME.md MAINTAINERS.md
...
* Tue Feb 03 2026 Maxwell G <maxwell@gtmx.me> - 10.2.6-24
- Rebuild for https://fedoraproject.org/wiki/Changes/golang1.26

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 10.2.6-23
