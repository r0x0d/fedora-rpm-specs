...
# * Allow gethostname 0.4.3
Patch:          x11rb-fix-metadata.diff
...
%package     -n %{name}+allow-unsafe-code-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+allow-unsafe-code-devel %{_description}

This package contains library source intended for building other packages which
use the "allow-unsafe-code" feature of the "%{crate}" crate.

%files       -n %{name}+allow-unsafe-code-devel
%ghost %{crate_instdir}/Cargo.toml
...
%package     -n %{name}+dl-libxcb-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+dl-libxcb-devel %{_description}

This package contains library source intended for building other packages which
use the "dl-libxcb" feature of the "%{crate}" crate.

%files       -n %{name}+dl-libxcb-devel
%ghost %{crate_instdir}/Cargo.toml
