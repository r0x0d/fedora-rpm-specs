...
%changelog
* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 1:43.2-3
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1:43.2-2
...
* Sat Mar 22 2025 Daniel Rusek <mail@asciiwolf.com> - 1:43.1-5
- Fixed thumbnailer crashing on large files
