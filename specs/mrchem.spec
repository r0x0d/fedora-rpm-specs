...
%changelog
* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 1.1.4-12
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.1.4-11
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 1.1.4-10
- Rebuilt for Python 3.15

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.1.4-9
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Oct 16 2025 Susi Lehtola <jussilehtola@fedoraproject.org> - 1.1.4-8
- rebuild for eigen3 5.0.0

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 1.1.4-7
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 1.1.4-6
