...
%changelog
* Mon Aug 03 2026 Miroslav Lichvar <mlichvar@redhat.com> 1.2.5-1
- update to 1.2.5 (CVE-2026-18321)

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 1.2.4-13
...
* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.2.4-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 1.2.4-7
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 1.2.4-6
