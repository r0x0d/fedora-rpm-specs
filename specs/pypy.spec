...
# Patch for the bundled pip wheel for CVE-2026-3219
# Reject ambiguous polyglot ZIP+TAR archives in unpack_file
# Resolved upstream: https://github.com/pypa/pip/pull/13870
Source11: pip-CVE-2026-3219.patch
...
%if %{without rpmwheels}
# Patch the bundled pip wheel for CVE-2023-5752, CVE-2024-47081, CVE-2025-50181, CVE-2025-8869, CVE-2026-25645, CVE-2026-3219
