...
# ghc-temporary ghc-tasty-hunit ghc-tasty ghc-optparse-applicative ghc-prettyprinter-ansi-terminal ghc-doctest
# Shortest path subcycles: ghc-doctest ghc-prettyprinter-ansi-terminal ghc-optparse-applicative ghc-tasty ghc-temporary
%bcond tests 0
