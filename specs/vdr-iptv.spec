...
%changelog
* Mon Feb 09 2026 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-41
- Rebuilt for new VDR API version 2.7.9

* Mon Jan 26 2026 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-40
- Rebuilt for new VDR API version 2.7.8

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.4.0-39
...
* Sat Jun 21 2025 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-36
- Rebuilt for new VDR API version 2.7.6

* Tue May 27 2025 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-35
- Rebuilt for new VDR API version 2.7.5

* Fri Feb 28 2025 Martin Gansser <martinkg@fedoraproject.org> - 2.4.0-34
