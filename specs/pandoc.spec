...
%global citeproc citeproc-0.8.1.1
%global commonmark commonmark-0.2.6
%global commonmarkextensions commonmark-extensions-0.2.5.5
%global commonmarkpandoc commonmark-pandoc-0.2.2.1
...
%global typst typst-0.5.0.1
%global unicodecollation unicode-collation-0.1.3.6

%global subpkgs %{commonmark} %{commonmarkextensions} %{commonmarkpandoc} %{digits} %{gridtables} %{ipynb} %{jirawikimarkup} %{orderedcontainers} %{typst} %{unicodecollation} %{citeproc}
...
Source6:        https://hackage.haskell.org/package/%{gridtables}/%{gridtables}.tar.gz
