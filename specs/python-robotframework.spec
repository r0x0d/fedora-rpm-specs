...
%changelog
* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 7.4.2-2
- Rebuilt for Python 3.15

* Tue Mar 03 2026 Federico Pellegrin <fede@evolware.org> - 7.4.2-1
- Upgrade to 7.4.2
...
* Mon Dec 15 2025 Federico Pellegrin <fede@evolware.org> - 7.4-1
- Upgrade to 7.4

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 7.3.2-4
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 7.3.2-3
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 7.3.2-2
...
* Wed Mar 19 2025 Federico Pellegrin <fede@evolware.org> - 7.2.2-1
- Upgrade to 7.2.2
