...
Name:           evemu
Version:        2.7.0
Release:        40%{?gitdate:.%{gitdate}git%{gitversion}}%{?dist}
...
%changelog
* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 2.7.0-40
- Rebuilt for Python 3.15.0b4 ABI change

* Wed Jul 15 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.7.0-39
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 2.7.0-38
- Rebuilt for Python 3.15

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.7.0-37
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 2.7.0-36
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 2.7.0-35
- Rebuilt for Python 3.14.0rc2 bytecode

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.7.0-34
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 2.7.0-33
- Rebuilt for Python 3.14

* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.7.0-32
