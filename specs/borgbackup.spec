...
* Wed Jul 15 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.4.4-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Fri Jun 12 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 1.4.4-3
- Rebuilt for openssl 4.0

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 1.4.4-2
- Rebuilt for Python 3.15

* Sun Mar 29 2026 Felix Schwarz <fschwarz@fedoraproject.org> - 1.4.4-1
- update to 1.4.4

* Sun Feb 08 2026 Felix Schwarz <fschwarz@fedoraproject.org> - 1.4.3-4
- remove unnecessary build dependency on python-dateutil

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.4.3-3
...
* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 1.4.1-2
