...
# * Relax hashlink dependency
Patch:          sqlx-core-fix-metadata.diff
...
%package     -n %{name}+_tls-rustls-ring-native-roots-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+_tls-rustls-ring-native-roots-devel %{_description}

This package contains library source intended for building other packages which
use the "_tls-rustls-ring-native-roots" feature of the "%{crate}" crate.

%files       -n %{name}+_tls-rustls-ring-native-roots-devel
%ghost %{crate_instdir}/Cargo.toml

%package     -n %{name}+_tls-rustls-ring-webpki-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+_tls-rustls-ring-webpki-devel %{_description}

This package contains library source intended for building other packages which
use the "_tls-rustls-ring-webpki" feature of the "%{crate}" crate.

%files       -n %{name}+_tls-rustls-ring-webpki-devel
%ghost %{crate_instdir}/Cargo.toml
