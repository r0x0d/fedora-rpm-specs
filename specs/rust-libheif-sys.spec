...
%global crate_version 5.1.0+1.21.1
...
BuildRequires:  pkgconfig(libheif) >= 1.21
...
Summary:        %{summary}
BuildArch:      noarch
Requires:       pkgconfig(libheif) >= 1.21
...
%cargo_generate_buildrequires -f v1_21

%build
%cargo_build -f v1_21

%install
%cargo_install -f v1_21

%if %{with check}
%check
# * skip a test that expects a an exact libheif version
%cargo_test -f v1_21 -- -- --skip create_heic_context
%endif
