%global commit 138fdb258d9fc26f1843fd1b891180416c9dc575
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global gitdate 20251114
...
%build
%make_build SYS=posix CRYPTO=GNUTLS SHARED=yes XCFLAGS="%{build_cflags}" XLDFLAGS="%{build_ldflags}"

%install
%make_install CRYPTO=GNUTLS SHARED=yes prefix=%{_prefix} mandir=%{_mandir} libdir=%{_libdir} sbindir=%{_sbindir} install
rm -v %{buildroot}%{_libdir}/librtmp.a
...
* Fri Jun 19 2026 Dominik Mierzejewski <dominik@greysector.net> - 2.6~20240301git6f6bb13-2
- use SourceLicense: tag to describe source license accurately
- use SPDX expression for -devel subpackage license
- use build_cflags instead of optflags

* Wed Jun 17 2026 Dominik Mierzejewski <dominik@greysector.net> - 2.6~20240301git6f6bb13-1
- modernize spec
- use proper macros
- BuildRequire make explicitly
- ensure Fedora CFLAGS and LDFLAGS are used

* Mon Feb 02 2026 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 2.6-3.20240301.git6f6bb13
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Sun Jul 27 2025 RPM Fusion Release Engineering <sergiomb@rpmfusion.org> - 2.6-2.20240301.git6f6bb13
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Thu Feb 06 2025 Sérgio Basto <sergio@serjux.com> - 2.6-1.20240301.git6f6bb13
- Version 2.6 from git
