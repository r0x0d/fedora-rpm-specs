...
Provides: bundled(golang(cloud.google.com/go/storage)) = 1.41.0
Provides: bundled(golang(cloud.google.com/go/storage/internal)) = 1.41.0
Provides: bundled(golang(cloud.google.com/go/storage/internal/apiv2)) = 1.41.0
Provides: bundled(golang(cloud.google.com/go/storage/internal/apiv2/storagepb)) = 1.41.0
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/arn)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/auth/bearer)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/awserr)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/awsutil)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/client)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/client/metadata)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/corehandlers)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/ec2rolecreds)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/endpointcreds)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/processcreds)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/ssocreds)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/stscreds)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/csm)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/defaults)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/ec2metadata)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/endpoints)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/request)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/session)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/signer/v4)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/context)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/ini)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/s3shared)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/s3shared/arn)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/s3shared/s3err)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sdkio)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sdkmath)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sdkrand)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sdkuri)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/shareddefaults)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/strings)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sync/singleflight)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/checksum)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/eventstream)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/eventstream/eventstreamapi)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/json/jsonutil)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/jsonrpc)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/query)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/query/queryutil)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/rest)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/restjson)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/restxml)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/xml/xmlutil)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/s3)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/s3/s3iface)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/s3/s3manager)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/sso)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/ssooidc)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/sso/ssoiface)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/sts)) = 1.53.5
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/sts/stsiface)) = 1.53.5
...
Provides: bundled(golang(golang.org/x/net/bpf)) = 0.25.0
Provides: bundled(golang(golang.org/x/net/http2)) = 0.25.0
Provides: bundled(golang(golang.org/x/net/http2/hpack)) = 0.25.0
Provides: bundled(golang(golang.org/x/net/http/httpguts)) = 0.25.0
Provides: bundled(golang(golang.org/x/net/http/httpproxy)) = 0.25.0
Provides: bundled(golang(golang.org/x/net/idna)) = 0.25.0
Provides: bundled(golang(golang.org/x/net/internal/timeseries)) = 0.25.0
Provides: bundled(golang(golang.org/x/net/trace)) = 0.25.0
Provides: bundled(golang(golang.org/x/oauth2)) = 0.20.0
...
Provides: bundled(golang(golang.org/x/oauth2/google/internal/externalaccountauthorizeduser)) = 0.20.0
...
Provides: bundled(golang(google.golang.org/api/googleapi)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/googleapi/transport)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/iamcredentials/v1)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/internal)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/internal/cert)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/internal/gensupport)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/internal/impersonate)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/internal/third_party/uritemplates)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/iterator)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/option)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/option/internaloption)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/storage/v1)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/transport)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/transport/grpc)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/transport/http)) = 0.181.0
Provides: bundled(golang(google.golang.org/api/transport/http/internal/propagation)) = 0.181.0
...
* Wed Jun 05 2024 Steven Prestil <spresti@redhat.com> - 2.19.0-1
- New release
