...
Provides: bundled(golang(cloud.google.com/go/storage/experimental)) = 1.50.0
Provides: bundled(golang(cloud.google.com/go/storage/internal)) = 1.50.0
Provides: bundled(golang(cloud.google.com/go/storage/internal/apiv2)) = 1.50.0
Provides: bundled(golang(cloud.google.com/go/storage/internal/apiv2/storagepb)) = 1.50.0
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/arn)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/auth/bearer)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/awserr)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/awsutil)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/client)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/client/metadata)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/corehandlers)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/ec2rolecreds)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/endpointcreds)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/processcreds)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/ssocreds)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/credentials/stscreds)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/csm)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/defaults)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/ec2metadata)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/endpoints)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/request)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/session)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/aws/signer/v4)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/context)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/ini)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/s3shared)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/s3shared/arn)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/s3shared/s3err)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sdkio)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sdkmath)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sdkrand)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sdkuri)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/shareddefaults)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/strings)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/internal/sync/singleflight)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/checksum)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/eventstream)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/eventstream/eventstreamapi)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/json/jsonutil)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/jsonrpc)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/query)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/query/queryutil)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/rest)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/restjson)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/restxml)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/private/protocol/xml/xmlutil)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/s3)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/s3/s3iface)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/s3/s3manager)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/sso)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/ssooidc)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/sso/ssoiface)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/sts)) = 1.55.6
Provides: bundled(golang(github.com/aws/aws-sdk-go/service/sts/stsiface)) = 1.55.6
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/azidentity)) = 1.8.2
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/azidentity/internal)) = 1.8.2
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/storage/azblob)) = 1.6.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/storage/azblob/appendblob)) = 1.6.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/storage/azblob/blob)) = 1.6.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/storage/azblob/bloberror)) = 1.6.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/storage/azblob/blockblob)) = 1.6.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/storage/azblob/container)) = 1.6.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/storage/azblob/internal/base)) = 1.6.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/storage/azblob/internal/exported)) = 1.6.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/storage/azblob/internal/generated)) = 1.6.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/storage/azblob/internal/shared)) = 1.6.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/storage/azblob/pageblob)) = 1.6.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/storage/azblob/sas)) = 1.6.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/storage/azblob/service)) = 1.6.0
Provides: bundled(golang(github.com/beevik/etree)) = 1.5.0
...
Provides: bundled(golang(golang.org/x/net/bpf)) = 0.37.0
Provides: bundled(golang(golang.org/x/net/http2)) = 0.37.0
Provides: bundled(golang(golang.org/x/net/http2/hpack)) = 0.37.0
Provides: bundled(golang(golang.org/x/net/http/httpguts)) = 0.37.0
Provides: bundled(golang(golang.org/x/net/http/httpproxy)) = 0.37.0
Provides: bundled(golang(golang.org/x/net/idna)) = 0.37.0
Provides: bundled(golang(golang.org/x/net/internal/httpcommon)) = 0.37.0
Provides: bundled(golang(golang.org/x/net/internal/timeseries)) = 0.37.0
Provides: bundled(golang(golang.org/x/net/trace)) = 0.37.0
Provides: bundled(golang(golang.org/x/oauth2)) = 0.28.0
Provides: bundled(golang(golang.org/x/oauth2/authhandler)) = 0.28.0
Provides: bundled(golang(golang.org/x/oauth2/google)) = 0.28.0
Provides: bundled(golang(golang.org/x/oauth2/google/externalaccount)) = 0.28.0
Provides: bundled(golang(golang.org/x/oauth2/google/internal/externalaccountauthorizeduser)) = 0.28.0
Provides: bundled(golang(golang.org/x/oauth2/google/internal/impersonate)) = 0.28.0
Provides: bundled(golang(golang.org/x/oauth2/google/internal/stsexchange)) = 0.28.0
Provides: bundled(golang(golang.org/x/oauth2/internal)) = 0.28.0
Provides: bundled(golang(golang.org/x/oauth2/jws)) = 0.28.0
Provides: bundled(golang(golang.org/x/oauth2/jwt)) = 0.28.0
Provides: bundled(golang(golang.org/x/sys/cpu)) = 0.31.0
Provides: bundled(golang(golang.org/x/sys/unix)) = 0.31.0
Provides: bundled(golang(golang.org/x/sys/windows)) = 0.31.0
Provides: bundled(golang(golang.org/x/sys/windows/registry)) = 0.31.0
Provides: bundled(golang(google.golang.org/api/googleapi)) = 0.224.0
Provides: bundled(golang(google.golang.org/api/googleapi/transport)) = 0.224.0
Provides: bundled(golang(google.golang.org/api/iamcredentials/v1)) = 0.224.0
Provides: bundled(golang(google.golang.org/api/internal)) = 0.224.0
Provides: bundled(golang(google.golang.org/api/internal/cert)) = 0.224.0
Provides: bundled(golang(google.golang.org/api/internal/gensupport)) = 0.224.0
Provides: bundled(golang(google.golang.org/api/internal/impersonate)) = 0.224.0
Provides: bundled(golang(google.golang.org/api/internal/third_party/uritemplates)) = 0.224.0
Provides: bundled(golang(google.golang.org/api/iterator)) = 0.224.0
Provides: bundled(golang(google.golang.org/api/option)) = 0.224.0
Provides: bundled(golang(google.golang.org/api/option/internaloption)) = 0.224.0
Provides: bundled(golang(google.golang.org/api/storage/v1)) = 0.224.0
Provides: bundled(golang(google.golang.org/api/transport)) = 0.224.0
Provides: bundled(golang(google.golang.org/api/transport/grpc)) = 0.224.0
Provides: bundled(golang(google.golang.org/api/transport/http)) = 0.224.0
