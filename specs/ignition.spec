...
Provides: bundled(golang(cloud.google.com/go/storage)) = 1.57.0
Provides: bundled(golang(cloud.google.com/go/storage/experimental)) = 1.57.0
Provides: bundled(golang(cloud.google.com/go/storage/internal)) = 1.57.0
Provides: bundled(golang(cloud.google.com/go/storage/internal/apiv2)) = 1.57.0
Provides: bundled(golang(cloud.google.com/go/storage/internal/apiv2/storagepb)) = 1.57.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/azidentity)) = 1.13.0
Provides: bundled(golang(github.com/Azure/azure-sdk-for-go/sdk/azidentity/internal)) = 1.13.0
...
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/aws)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/aws/arn)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/aws/defaults)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/aws/middleware)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/aws/protocol/xml)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/aws/ratelimit)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/aws/retry)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/aws/signer/internal/v4)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/aws/signer/v4)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/aws/transport/http)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/auth)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/auth/smithy)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/awsutil)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/context)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/endpoints)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/endpoints/awsrulesfn)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/middleware)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/rand)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/sdk)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/sdkio)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/strings)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/sync/singleflight)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/timeconv)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/aws/protocol/eventstream)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/aws/protocol/eventstream/eventstreamapi)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/credentials/ec2rolecreds)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/feature/ec2/imds)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/feature/ec2/imds/internal/config)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/feature/s3/manager)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/configsources)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/endpoints/v2)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/v4a)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/v4a/internal/crypto)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/internal/v4a/internal/v4)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/internal/accept-encoding)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/internal/checksum)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/internal/presigned-url)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/internal/s3shared)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/internal/s3shared/arn)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/internal/s3shared/config)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/s3)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/s3/internal/arn)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/s3/internal/customizations)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/s3/internal/endpoints)) = 1.39.2
Provides: bundled(golang(github.com/aws/aws-sdk-go-v2/service/s3/types)) = 1.39.2
...
Provides: bundled(golang(golang.org/x/net/bpf)) = 0.46.0
Provides: bundled(golang(golang.org/x/net/http/httpguts)) = 0.46.0
Provides: bundled(golang(golang.org/x/net/http/httpproxy)) = 0.46.0
Provides: bundled(golang(golang.org/x/net/http2)) = 0.46.0
Provides: bundled(golang(golang.org/x/net/http2/hpack)) = 0.46.0
Provides: bundled(golang(golang.org/x/net/idna)) = 0.46.0
Provides: bundled(golang(golang.org/x/net/internal/httpcommon)) = 0.46.0
Provides: bundled(golang(golang.org/x/net/internal/timeseries)) = 0.46.0
Provides: bundled(golang(golang.org/x/net/trace)) = 0.46.0
Provides: bundled(golang(golang.org/x/oauth2)) = 0.32.0
Provides: bundled(golang(golang.org/x/oauth2/authhandler)) = 0.32.0
Provides: bundled(golang(golang.org/x/oauth2/google)) = 0.32.0
Provides: bundled(golang(golang.org/x/oauth2/google/externalaccount)) = 0.32.0
Provides: bundled(golang(golang.org/x/oauth2/google/internal/externalaccountauthorizeduser)) = 0.32.0
Provides: bundled(golang(golang.org/x/oauth2/google/internal/impersonate)) = 0.32.0
Provides: bundled(golang(golang.org/x/oauth2/google/internal/stsexchange)) = 0.32.0
Provides: bundled(golang(golang.org/x/oauth2/internal)) = 0.32.0
Provides: bundled(golang(golang.org/x/oauth2/jws)) = 0.32.0
Provides: bundled(golang(golang.org/x/oauth2/jwt)) = 0.32.0
Provides: bundled(golang(golang.org/x/sys/cpu)) = 0.37.0
Provides: bundled(golang(golang.org/x/sys/unix)) = 0.37.0
Provides: bundled(golang(golang.org/x/sys/windows)) = 0.37.0
Provides: bundled(golang(golang.org/x/sys/windows/registry)) = 0.37.0
Provides: bundled(golang(google.golang.org/api/googleapi)) = 0.252.0
Provides: bundled(golang(google.golang.org/api/googleapi/transport)) = 0.252.0
Provides: bundled(golang(google.golang.org/api/iamcredentials/v1)) = 0.252.0
Provides: bundled(golang(google.golang.org/api/internal)) = 0.252.0
Provides: bundled(golang(google.golang.org/api/internal/cert)) = 0.252.0
Provides: bundled(golang(google.golang.org/api/internal/gensupport)) = 0.252.0
Provides: bundled(golang(google.golang.org/api/internal/impersonate)) = 0.252.0
Provides: bundled(golang(google.golang.org/api/internal/third_party/uritemplates)) = 0.252.0
Provides: bundled(golang(google.golang.org/api/iterator)) = 0.252.0
Provides: bundled(golang(google.golang.org/api/option)) = 0.252.0
Provides: bundled(golang(google.golang.org/api/option/internaloption)) = 0.252.0
Provides: bundled(golang(google.golang.org/api/storage/v1)) = 0.252.0
Provides: bundled(golang(google.golang.org/api/transport)) = 0.252.0
Provides: bundled(golang(google.golang.org/api/transport/grpc)) = 0.252.0
Provides: bundled(golang(google.golang.org/api/transport/http)) = 0.252.0
