...
%define gitshort b76effd
%define dtbver 6.18.48
...
%changelog
* Tue Sep 08 2026 Peter Robinson <pbrobinson@fedoraproject.org> - 20260907-1.b76effd
- Update to the latest firmware
- Update to 6.18.48 DT and overlay fixes
- Fixes for CM4 peripherals

* Mon Aug 24 2026 Peter Robinson <pbrobinson@fedoraproject.org> - 20260810-1.3d301dd
- Update to latest firmware
- Update to 6.18.45 DT and overlay fixes

* Fri Aug 07 2026 Peter Robinson <pbrobinson@fedoraproject.org> - 20260806-1.2cfe163
- Update to latest firmware
- Update to 6.18.42 DT and overlay fixes

* Fri Jul 24 2026 Peter Robinson <pbrobinson@fedoraproject.org> - 20260723-1.8402891
- Update to latest firmware
- Update to 6.18.39 DT and overlay fixes

* Thu Jul 02 2026 Peter Robinson <pbrobinson@fedoraproject.org> - 20260701-1.ea3bc5a
- Update to latest firmware
- Update to 6.18.37 DT and overlay fixes
...
* Mon Dec 08 2025 Peter Robinson <pbrobinson@fedoraproject.org> - 20251127-1.6bb0bae
- Update to latest firmware

* Fri Oct 17 2025 Peter Robinson <pbrobinson@fedoraproject.org> - 20250820-2.0641c5b
- Reorg config.txt to fix CMA on smaller devices (rhbz#2404622)
- Re-sync the rpi4-series FW DTBs
...
* Mon Jul 21 2025 Peter Robinson <pbrobinson@fedoraproject.org> - 20250717-1.4558d93
- Update to latest firmware

* Sat Jun 14 2025 Peter Robinson <pbrobinson@fedoraproject.org> - 20250514-1.6f2b7e2
- Update to latest firmware

* Wed Mar 19 2025 Peter Robinson <pbrobinson@fedoraproject.org> - 20250319-1.80f23d4
- Update to latest firmware
