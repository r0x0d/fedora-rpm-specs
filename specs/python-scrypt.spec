...
%changelog
* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 0.9.4-5
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.9.4-4
...
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 0.8.27-6
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 0.8.27-5
