...
Patch10:        libbpf-rs-disable-probe-tests-on-ppc64le-s390x.diff
...
%{cargo_test -- -- %{shrink:
    --skip :root:
    --skip test_object_build_from_memory
    --skip test_object_build_from_memory_empty_name
    --skip test_object_name
    --skip test_object_link_files
}}
%endif
