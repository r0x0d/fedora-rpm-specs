...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.10.0-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Fri Jun 12 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 4.10.0-3
- Rebuilt for openssl 4.0

( Thu Jun 11 2026 Dmitri Smirnov <dmitri@smirnov.ee> 4.10.0-1
- Switch to ecc keys to fix signing as recommended by upstream devs
...
- Removed EL7 and EL8 leftovers
- Moved from Qt5 to Qt6
- Added cmake.patch

* Tue Feb 18 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 4.6.0-6
