...
%global commit de55dc5861bc9a9ca49fd7bf9a16372d1dc2a3be
%global shortcommit %{sub %{commit} 1 7}
%global commitdatestring 2024-09-24 09:31:55 -0400
...
License:        (BSD-2-Clause OR Apache-2.0 OR MIT) AND (MIT OR Zlib OR Apache-2.0) AND (MIT OR Apache-2.0 OR CC0-1.0) AND BSL-1.0 AND Zlib AND (Apache-2.0 WITH LLVM-exception OR Apache-2.0 OR MIT) AND (0BSD OR MIT OR Apache-2.0) AND (Apache-2.0 OR BSL-1.0) AND Apache-2.0 AND Unicode-3.0 AND ISC AND (MIT OR Apache-2.0 OR Zlib) AND MPL-2.0 AND (MIT OR Apache-2.0) AND CC0-1.0 AND MIT AND (Unlicense OR MIT) AND (Apache-2.0 OR MIT) AND BSD-3-Clause AND (Zlib OR Apache-2.0 OR MIT) AND BSD-2-Clause
