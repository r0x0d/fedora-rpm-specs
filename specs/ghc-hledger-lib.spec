...
%global deferredfolds deferred-folds-0.9.18.7
%global isomorphismclass isomorphism-class-0.3.0.1
%global lawfulconversions lawful-conversions-0.1.6
%global lucid lucid-2.11.20250303
%global pager pager-0.1.1.0
%global quickcheckinstances quickcheck-instances-0.3.32
%global quotequot quote-quot-0.2.1.0
%global textansi text-ansi-0.3.0.1
%global textbuilder text-builder-0.6.7.3
%global textbuilderdev text-builder-dev-0.3.9.1
%global textbuilderlinear text-builder-linear-0.1.3
%global timeit timeit-2.0

%global subpkgs %{breakpoint} %{cassavamegaparsec} %{deferredfolds} %{isomorphismclass} %{lawfulconversions} %{lucid} %{pager} %{quickcheckinstances} %{quotequot} %{textbuilderdev} %{textbuilder} %{textbuilderlinear} %{textansi} %{timeit}

# deferred-folds missing quickcheck-instances and rerebase
%bcond tests 0
...
Source5:        https://hackage.haskell.org/package/%{lawfulconversions}/%{lawfulconversions}.tar.gz
Source6:        https://hackage.haskell.org/package/%{lucid}/%{lucid}.tar.gz
Source7:        https://hackage.haskell.org/package/%{pager}/%{pager}.tar.gz
Source8:        https://hackage.haskell.org/package/%{quickcheckinstances}/%{quickcheckinstances}.tar.gz
Source9:        https://hackage.haskell.org/package/%{quotequot}/%{quotequot}.tar.gz
Source10:       https://hackage.haskell.org/package/%{textansi}/%{textansi}.tar.gz
Source11:       https://hackage.haskell.org/package/%{textbuilder}/%{textbuilder}.tar.gz
Source12:       https://hackage.haskell.org/package/%{textbuilderdev}/%{textbuilderdev}.tar.gz
Source13:       https://hackage.haskell.org/package/%{textbuilderlinear}/%{textbuilderlinear}.tar.gz
Source14:       https://hackage.haskell.org/package/%{timeit}/%{timeit}.tar.gz
Source15:       https://hackage.haskell.org/package/%{pkgver}/%{pkg_name}.cabal#/%{pkgver}.cabal
...
%ghc_lib_subpackage -l MIT %{lawfulconversions}
...
%setup -q -n %{pkgver} -a1 -a2 -a3 -a4 -a5 -a6 -a7 -a8 -a9 -a10 -a11 -a12 -a13 -a14
dos2unix -k -n %{SOURCE15} %{pkg_name}.cabal
# End cabal-rpm setup
(
cd %{pager}
%patch -P0 -p1
