...
%changelog
* Sun Aug 02 2026 Aleksei Bavshin <alebastr@fedoraproject.org> - 3.0.24-1
- Update to 3.0.24

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 3.0.23-3
- Rebuilt for Python 3.15.0b4 ABI change

* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.0.23-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Sun Jun 21 2026 Aleksei Bavshin <alebastr@fedoraproject.org> - 3.0.23-1
- Update to 3.0.23 (#2483946)

* Fri Jun 12 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 3.0.22-3
...
* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.0.18-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Dec 01 2025 Aleksei Bavshin <alebastr@fedoraproject.org> - 3.0.18-1
- Update to 3.0.18 (#2416934)
...
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 3.0.16-2
...
* Mon Jul 21 2025 Peter Robinson <pbrobinson@fedoraproject.org> - 3.0.15-2
- Rebuild for libwebsockets 4.4

* Sat Jun 28 2025 Aleksei Bavshin <alebastr@fedoraproject.org> - 3.0.15-1
- Update to 3.0.15 (#2362605)

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 3.0.13-2
