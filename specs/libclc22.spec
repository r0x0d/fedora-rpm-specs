...
sed -si "s|libexecdir=@CMAKE_INSTALL_PREFIX@/@CMAKE_INSTALL_DATADIR@/clc|libexecdir=@CMAKE_INSTALL_PREFIX@/@CMAKE_INSTALL_DATADIR@/%{shortname}|" libclc.pc.in
...
mv %{buildroot}%{_libdir}/clc %{buildroot}%{_libdir}/%{shortname}
