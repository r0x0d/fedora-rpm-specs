...
Patch:          0002-Relax-ipnetwork-dependency-to-allow-both-v0.20-and-v.patch
...
%install
install -Dpm 0755 target/rpm/mirrorlist-server -t %{buildroot}%{_bindir}
install -Dpm 0755 target/rpm/generate-mirrorlist-cache -t %{buildroot}%{_bindir}
