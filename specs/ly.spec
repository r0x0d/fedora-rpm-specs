...
%global zigini_ver 0.3.3
%global ini_ver 0.1.0
%global clap_hash clap-0.11.0-oBajB-HnAQDPCKYzwF7rO3qDFwRcD39Q0DALlTSz5H7e
%global zigini_hash zigini-0.3.3-36M0FRJJAADZVq5HPm-hYKMpFFTr0OgjbEYcK2ijKZ5n
%global ini_hash ini-0.1.0-YCQ9Ys0pAABixEvvQvhVXAdqRE3wrZk_wiL9TPNHhB8d
%global termbox2_hash N-V-__8AAOEWBQDt5tNdIzIFY6n8DdZsCP-6MyLoNS20wgpA
...
%zig_fetch vendor/p/%{clap_hash}
%zig_fetch vendor/p/%{zigini_hash}
%zig_fetch vendor/p/%{ini_hash}
%zig_fetch vendor/p/%{termbox2_hash}
...
chmod 0644 %{buildroot}%{_sysconfdir}/ly/setup.sh
...
install -pm0644 vendor/p/%{clap_hash}/LICENSE %{buildroot}%{_licensedir}/ly/LICENSE-zig-clap
install -pm0644 vendor/p/%{zigini_hash}/LICENSE %{buildroot}%{_licensedir}/ly/LICENSE-zigini
install -pm0644 vendor/p/%{ini_hash}/LICENCE %{buildroot}%{_licensedir}/ly/LICENSE-ini
install -pm0644 vendor/p/%{termbox2_hash}/LICENSE %{buildroot}%{_licensedir}/ly/LICENSE-termbox2
