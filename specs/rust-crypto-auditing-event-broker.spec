...
Source2:        crau-event-broker.service
Source3:        crau-event-broker.socket
...
%post -n %{crate}
%systemd_post crau-event-broker.service

%preun -n %{crate}
%systemd_preun crau-event-broker.service

%postun -n %{crate}
%systemd_postun_with_restart crau-event-broker.service
