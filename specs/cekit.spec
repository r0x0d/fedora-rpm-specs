...
%changelog
* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 4.16.0-2
- Rebuilt for Python 3.15

* Fri Jan 30 2026 Nick Cross <ncross@redhat.com> - 4.16.0-1
- Release 4.16.0

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.15.0-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.15.0-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 4.15.0-5
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 4.15.0-4
- Rebuilt for Python 3.14.0rc2 bytecode

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 4.15.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 4.15.0-2
- Rebuilt for Python 3.14

* Tue May 06 2025 Nick Cross <ncross@redhat.com> - 4.15.0-1
- Release 4.15.0
