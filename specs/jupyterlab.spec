...
Provides:        bundled(npm(@jupyterlab/application)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/application-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/apputils)) = 4.6.2
Provides:        bundled(npm(@jupyterlab/apputils-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/attachments)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/audio-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/cell-toolbar)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/cell-toolbar-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/cells)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/celltags-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/codeeditor)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/codemirror)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/codemirror-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/completer)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/completer-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/console)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/console-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/coreutils)) = 6.5.2
Provides:        bundled(npm(@jupyterlab/csvviewer)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/csvviewer-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/debugger)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/debugger-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/docmanager)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/docmanager-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/docregistry)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/documentsearch)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/documentsearch-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/extensionmanager)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/extensionmanager-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/filebrowser)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/filebrowser-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/fileeditor)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/fileeditor-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/help-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/htmlviewer)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/htmlviewer-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/hub-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/imageviewer)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/imageviewer-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/inspector)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/inspector-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/javascript-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/json-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/launcher)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/launcher-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/logconsole)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/logconsole-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/lsp)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/lsp-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/mainmenu)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/mainmenu-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/markdownviewer)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/markdownviewer-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/markedparser-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/mathjax-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/mermaid)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/mermaid-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/metadataform)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/metadataform-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/nbformat)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/notebook)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/notebook-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/observables)) = 5.5.2
Provides:        bundled(npm(@jupyterlab/outputarea)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/pdf-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/pluginmanager)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/pluginmanager-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/property-inspector)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/rendermime)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/rendermime-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/rendermime-interfaces)) = 3.13.2
Provides:        bundled(npm(@jupyterlab/running)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/running-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/services)) = 7.5.2
Provides:        bundled(npm(@jupyterlab/services-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/settingeditor)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/settingeditor-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/settingregistry)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/shortcuts-extension)) = 5.3.2
Provides:        bundled(npm(@jupyterlab/statedb)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/statusbar)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/statusbar-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/terminal)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/terminal-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/theme-dark-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/theme-dark-high-contrast-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/theme-light-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/toc)) = 6.5.2
Provides:        bundled(npm(@jupyterlab/toc-extension)) = 6.5.2
Provides:        bundled(npm(@jupyterlab/tooltip)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/tooltip-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/translation)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/translation-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/ui-components)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/ui-components-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/vega5-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/video-extension)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/workspaces)) = 4.5.2
Provides:        bundled(npm(@jupyterlab/workspaces-extension)) = 4.5.2
