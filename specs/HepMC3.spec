...
%changelog
* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 3.3.1-14
- Rebuilt for Python 3.15.0b4 ABI change

* Wed Jul 15 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.3.1-13
...
* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.3.1-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild
...
* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 3.3.1-5
- Rebuilt for Python 3.14.0rc2 bytecode

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.3.1-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jun 09 2025 Mattias Ellert <mattias.ellert@physics.uu.se> - 3.3.1-3
- Rebuild for root 6.36

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 3.3.1-2
- Rebuilt for Python 3.14

* Tue Mar 25 2025 Mattias Ellert <mattias.ellert@physics.uu.se> - 3.3.1-1
