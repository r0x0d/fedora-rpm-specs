...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.3.2-7
...
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 2.3.2-3
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 2.3.2-2
- Rebuilt for Python 3.14.0rc2 bytecode

* Sat Aug 09 2025 Julien Enselme <jujens@jujens.eu> - 2.3.2-1
- Update to 2.3.2
