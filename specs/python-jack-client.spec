...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.5.5-3
...
- Update BuildRequires, use %{pypi_source}, and fix %pyproject_save_files listing.
- Fix rpmlint warnings and adjust %files to use %{pyproject_files}.
