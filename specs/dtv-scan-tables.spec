...
Release:	%{rel}.%(echo %{date} | tr -d -)git%{git}%{?dist}.4
...
%changelog
* Wed Jul 15 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1-11.20240324git7098bdd27548.4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1-11.20240324git7098bdd27548.3
