...
Name:           python%{python3_pkgversion}-testpath-epel
Version:        0.6.0
Release:        7%{?dist}
...
%package -n     python%{python3_pkgversion}-testpath
Summary:        %summary

%description -n python%{python3_pkgversion}-testpath %_description
...
%files -n python%{python3_pkgversion}-testpath -f %{pyproject_files}
%doc README.rst
%license LICENSE
